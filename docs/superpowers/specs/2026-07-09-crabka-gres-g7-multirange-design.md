...
- **Transport security** — plaintext east-west inside the tenant boundary v1; mTLS follow-up flagged before any multi-tenant-shared network path exists.
