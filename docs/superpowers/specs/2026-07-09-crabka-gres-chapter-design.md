...
G-1 ──► G-2 ──► G-3 ──► G-4 ──► G-5
  ...
  └────► G-6 + SQL-breadth slices (parallel track)          G-8b reuses G-5 parking)
```
