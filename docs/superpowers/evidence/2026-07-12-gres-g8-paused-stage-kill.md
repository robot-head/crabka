...
the source of the wider gap. CI uses a 10,000ms Running ceiling, 1,778ms above the observed maximum.
...
took 4,315-4,806ms. CI uses a 10,000ms Checkpointed ceiling, 1,883ms above the observed maximum.
...
followed 4,681ms, 4,641ms, and 4,706ms later. CI therefore uses a phase-specific 15,000ms ceiling
...
4,179-4,205ms and restart-ready to publication took 4,670-5,667ms. CI uses a 15,000ms
