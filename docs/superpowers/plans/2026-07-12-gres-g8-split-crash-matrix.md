...
- Source/restore uses a 25-second bound, providing a strict CI margin above the measured 21.113-second process restart plus two-successor restore/prologue path. Publication and retirement use a strict 15-second bound above the measured 12.946-second unoptimized late process restart.
