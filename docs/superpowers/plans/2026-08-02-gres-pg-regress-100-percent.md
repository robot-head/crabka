...
- [ ] Resolve the fixture-enabled baseline changes before ratcheting: 17 worsened tests (`timestamptz`, `type_sanity`, `updatable_views`, `sanity_check`, `join`, `object_address`, `groupingsets`, `misc`, `merge`, `tidscan`, `psql`, `cluster`, `json_encoding`, `temp`, `rangefuncs`, `returning`, and `with`) and 36 equal-size changed fingerprints (`char`, `varchar`, `int4`, `int8`, `oid`, `float8`, `bit`, `money`, `pg_lsn`, `regproc`, `lseg`, `line`, `box`, `polygon`, `inet`, `macaddr`, `macaddr8`, `geometry`, `tstypes`, `expressions`, `xid`, `copyencoding`, `create_type`, `create_am`, `brin_multi`, `misc_functions`, `tid`, `create_role`, `subscription`, `select_views`, `foreign_data`, `xmlmap`, `json`, `jsonpath`, `xml`, and `compression`).
