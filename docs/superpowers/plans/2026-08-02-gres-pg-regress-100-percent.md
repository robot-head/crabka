...
- [ ] Implement inherited fixture tables, including merged parent columns and inheritance-aware scans, before treating `person`/`road` dependents as meaningful failures.
