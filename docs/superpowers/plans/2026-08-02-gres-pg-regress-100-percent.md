...
**Current state:** The authoritative serial result is `31/231` whole upstream
...
failures, leaving 200 semantic failures across 162084 canonical changed lines
and 4757 hunks. Both PostgreSQL self-check modes pass 231/231, the Gres
