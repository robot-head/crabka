...
| Kafka **Connect** framework + connectors + EOS source + REST/offsets APIs + Connect operator CRDs (KIP-26, 145, 158, 208, 215, 238, 298, 305, 558, 610, 611, 618, 745, 875, 980, …) | Connect equivalent not implemented (`KafkaConnect` CRD ❌). Ecosystem gap outside broker core. |
