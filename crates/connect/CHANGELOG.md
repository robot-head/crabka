...
- Add managed Postgres CDC connectors ([#981](https://github.com/robot-head/crabka/pull/981))
...
- Embeddable connector runtime + lifecycle ([#577](https://github.com/robot-head/crabka/pull/577))
