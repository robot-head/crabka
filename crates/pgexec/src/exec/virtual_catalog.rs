...
pub(crate) fn virtual_table(name: &str) -> Option<&'static str> {
    match name.strip_prefix("pg_catalog.").unwrap_or(name) {
        ...
        "pg_ts_parser" => Some("pg_ts_parser"),
        "pg_ts_template" => Some("pg_ts_template"),
        "pg_ts_config_map" => Some("pg_ts_config_map"),
...
pub(crate) fn virtual_catalog_columns(name: &str) -> Vec<Column> {
    ...
    match name {
        ...
        "pg_ts_parser" => cols(&[
            ...
            ("prsname", Text),
            ("prsnamespace", Int4),
            ("prsstart", ColumnType::Regproc),
            ("prstoken", ColumnType::Regproc),
            ("prsend", ColumnType::Regproc),
            ("prsheadline", ColumnType::Regproc),
            ("prslextype", ColumnType::Regproc),
        ]),
        "pg_ts_template" => cols(&[
            ("oid", Int4),
            ("tmplname", Text),
            ("tmplnamespace", Int4),
            ("tmplinit", ColumnType::Regproc),
            ("tmpllexize", ColumnType::Regproc),
        ]),
        "pg_ts_config_map" => cols(&[
            ("mapcfg", Int4),
            ("maptokentype", Int4),
            ("mapseqno", Int4),
            ("mapdict", Int4),
