...
pub fn op_config(namespace: &str) -> OperatorConfig {
    OperatorConfig {
        ...
        pgdog_reload_backoff_ms: "100".parse().unwrap(),
        pgdog_reload_requeue_ms: "15000".parse().unwrap(),
        pgdog_admin_timeout_ms: "20000".parse().unwrap(),
        pgdog_transition_poll_ms: "60000".parse().unwrap(),
        controller_error_requeue_ms: "15000".parse().unwrap(),
