...
pub use compactor::{
    ...
    CompactionPollResult, CompactionSeriesLabels, CompactionWalRecord, CompactionWindowError,
    CompactionWindowResult, CompactionWriteError, DEFAULT_FLUSH_MAX_AGE, DEFAULT_FLUSH_MAX_ROWS,
    ...
    encode_tenant_batches, poll_compactor_consumer_once, poll_compactor_once,
