...
impl<'de> Decode<'de> for LeaveGroupResponse {
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 3 { out.members = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(MemberResponse::decode(buf, version)?); } v }; }
        if flex {
...
pub fn default_json() -> ::serde_json::Value {
    ::serde_json::json!({"ThrottleTimeMs": 0, "ErrorCode": 0, "Members": []})
}
