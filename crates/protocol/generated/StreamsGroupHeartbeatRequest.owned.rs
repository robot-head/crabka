...
pub struct StreamsGroupHeartbeatRequest {
    ...
    pub client_tags: Option<Vec<super::common::key_value::KeyValue>>,
    pub task_offsets: Option<Vec<super::common::task_offset::TaskOffset>>,
    pub task_end_offsets: Option<Vec<super::common::task_offset::TaskOffset>>,
...
impl Encode for StreamsGroupHeartbeatRequest {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        ...
        if version >= 0 { if flex { put_compact_nullable_string(buf, self.process_id.as_deref()) } else { put_nullable_string(buf, self.process_id.as_deref()) } }
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 { n += if flex { compact_nullable_string_len(self.process_id.as_deref()) } else { nullable_string_len(self.process_id.as_deref()) }; }
...
impl<'de> Decode<'de> for StreamsGroupHeartbeatRequest {
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.topology = if get_i8(buf)? < 0 { None } else { Some(Topology::decode(buf, version)?) }; }
        ...
        if version >= 0 { out.process_id = if flex { get_compact_nullable_string_owned(buf)? } else { get_nullable_string_owned(buf)? }; }
        if version >= 0 { out.user_endpoint = if get_i8(buf)? < 0 { None } else { Some(super::common::endpoint::Endpoint::decode(buf, version)?) }; }
        if version >= 0 { out.client_tags = { let opt = crate::primitives::array::get_nullable_array_len(buf, flex)?; match opt { None => None, Some(n) => { let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(super::common::key_value::KeyValue::decode(buf, version)?); } Some(v) } } }; }
        if version >= 0 { out.task_offsets = { let opt = crate::primitives::array::get_nullable_array_len(buf, flex)?; match opt { None => None, Some(n) => { let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(super::common::task_offset::TaskOffset::decode(buf, version)?); } Some(v) } } }; }
        if version >= 0 { out.task_end_offsets = { let opt = crate::primitives::array::get_nullable_array_len(buf, flex)?; match opt { None => None, Some(n) => { let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(super::common::task_offset::TaskOffset::decode(buf, version)?); } Some(v) } } }; }
...
impl<'de> Decode<'de> for Topology {
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.subtopologies = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(Subtopology::decode(buf, version)?); } v }; }
        if flex {
            out.unknown_tagged_fields = read_tagged_fields(buf, |_tag, _payload| {
                Ok(false)
            })?;
...
impl<'de> Decode<'de> for Subtopology {
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.source_topics = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(if flex { get_compact_string_owned(buf)? } else { get_string_owned(buf)? }); } v }; }
        if version >= 0 { out.source_topic_regex = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(if flex { get_compact_string_owned(buf)? } else { get_string_owned(buf)? }); } v }; }
        if version >= 0 { out.state_changelog_topics = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(super::common::topic_info::TopicInfo::decode(buf, version)?); } v }; }
        if version >= 0 { out.repartition_sink_topics = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(if flex { get_compact_string_owned(buf)? } else { get_string_owned(buf)? }); } v }; }
        if version >= 0 { out.repartition_source_topics = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(super::common::topic_info::TopicInfo::decode(buf, version)?); } v }; }
        if version >= 0 { out.copartition_groups = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(CopartitionGroup::decode(buf, version)?); } v }; }
        if flex {
            out.unknown_tagged_fields = read_tagged_fields(buf, |_tag, _payload| {
                Ok(false)
            })?;
