...
impl Encode for DeleteShareGroupOffsetsRequest {
...
impl<'de> Decode<'de> for DeleteShareGroupOffsetsRequest {
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.topics = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(DeleteShareGroupOffsetsRequestTopic::decode(buf, version)?); } v }; }
        if flex {
...
impl Encode for DeleteShareGroupOffsetsRequestTopic {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        let flex = version >= 0;
...
impl crate::ProtocolRequest for DeleteShareGroupOffsetsRequest {
    ...
    type Response = super::delete_share_group_offsets_response::DeleteShareGroupOffsetsResponse;
}
