...
impl BrokerRegistrationChangeRecord {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::broker_registration_change_record::BrokerRegistrationChangeRecord {
...
impl Encode for BrokerRegistrationChangeRecord {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        if !(MIN_VERSION..=MAX_VERSION).contains(&version) {
            return Err(ProtocolError::SchemaMismatch("BrokerRegistrationChangeRecord version out of range"));
        }
