...
impl FetchResponse<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::fetch_response::FetchResponse {
        crate::owned::fetch_response::FetchResponse {
            ...
            responses: (self.responses).iter().map(FetchableTopicResponse::to_owned).collect(),
                ...
                0 => {
                    tag_node_endpoints = Some({
                        let b: &mut &[u8] = payload;
                        {
                            ...
                            let mut v = Vec::with_capacity(n);
                            for _ in 0..n {
                                v.push(crate::owned::fetch_response::NodeEndpoint::decode(b, version)?);
                            }
                            v
                        }
                    });
...
impl FetchResponse<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 16 {
            m.node_endpoints = vec![crate::owned::fetch_response::NodeEndpoint::populated(version)];
        }
        m
    }
}
...
impl<'a> PartitionData<'a> {
    ...
    pub fn to_owned(&self) -> crate::owned::fetch_response::PartitionData {
        crate::owned::fetch_response::PartitionData {
            ...
            aborted_transactions: (self.aborted_transactions).as_ref().map(|v| v.iter().map(AbortedTransaction::to_owned).collect()),
