...
impl TxnOffsetCommitResponse<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::txn_offset_commit_response::TxnOffsetCommitResponse {
        crate::owned::txn_offset_commit_response::TxnOffsetCommitResponse {
            ...
            topics: (self.topics).iter().map(TxnOffsetCommitResponseTopic::to_owned).collect(),
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.topics = {
                ...
                for _ in 0..n {
                    v.push(TxnOffsetCommitResponseTopic::decode_borrow(buf, version)?);
                }
                v
            };
        }
...
impl TxnOffsetCommitResponse<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.topics = vec![TxnOffsetCommitResponseTopic::populated(version)];
        }
        m
    }
}
...
impl TxnOffsetCommitResponseTopic<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::txn_offset_commit_response::TxnOffsetCommitResponseTopic {
        crate::owned::txn_offset_commit_response::TxnOffsetCommitResponseTopic {
            name: (self.name).to_string(),
            partitions: (self.partitions).iter().map(TxnOffsetCommitResponsePartition::to_owned).collect(),
            unknown_tagged_fields: self.unknown_tagged_fields.clone(),
        }
    }
}
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.partitions = {
                ...
                let mut v = Vec::with_capacity(n);
                for _ in 0..n {
                    v.push(TxnOffsetCommitResponsePartition::decode_borrow(buf, version)?);
                }
                v
            };
        }
...
impl TxnOffsetCommitResponsePartition {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::txn_offset_commit_response::TxnOffsetCommitResponsePartition {
