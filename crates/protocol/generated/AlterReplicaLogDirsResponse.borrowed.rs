...
impl<'a> AlterReplicaLogDirsResponse<'a> {
    pub fn to_owned(&self) -> crate::owned::alter_replica_log_dirs_response::AlterReplicaLogDirsResponse {
...
impl<'de> DecodeBorrow<'de> for AlterReplicaLogDirsResponse<'de> {
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.results = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(AlterReplicaLogDirTopicResult::decode_borrow(buf, version)?); } v }; }
        if flex {
...
impl<'a> AlterReplicaLogDirTopicResult<'a> {
    pub fn to_owned(&self) -> crate::owned::alter_replica_log_dirs_response::AlterReplicaLogDirTopicResult {
...
impl<'de> DecodeBorrow<'de> for AlterReplicaLogDirTopicResult<'de> {
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.partitions = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(AlterReplicaLogDirPartitionResult::decode_borrow(buf, version)?); } v }; }
        if flex {
            out.unknown_tagged_fields = read_tagged_fields(buf, |_tag, _payload| {
                Ok(false)
            })?;
...
impl AlterReplicaLogDirPartitionResult {
    pub fn to_owned(&self) -> crate::owned::alter_replica_log_dirs_response::AlterReplicaLogDirPartitionResult {
