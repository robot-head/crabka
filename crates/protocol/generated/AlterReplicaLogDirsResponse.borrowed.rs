...
impl AlterReplicaLogDirsResponse<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::alter_replica_log_dirs_response::AlterReplicaLogDirsResponse {
        crate::owned::alter_replica_log_dirs_response::AlterReplicaLogDirsResponse {
            ...
            results: (self.results).iter().map(AlterReplicaLogDirTopicResult::to_owned).collect(),
...
impl AlterReplicaLogDirTopicResult<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::alter_replica_log_dirs_response::AlterReplicaLogDirTopicResult {
        crate::owned::alter_replica_log_dirs_response::AlterReplicaLogDirTopicResult {
            ...
            partitions: (self.partitions).iter().map(AlterReplicaLogDirPartitionResult::to_owned).collect(),
            unknown_tagged_fields: self.unknown_tagged_fields.clone(),
        }
    }
}
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.partitions = {
                ...
                let mut v = Vec::with_capacity(n);
                for _ in 0..n {
                    v.push(AlterReplicaLogDirPartitionResult::decode_borrow(buf, version)?);
                }
                v
            };
        }
