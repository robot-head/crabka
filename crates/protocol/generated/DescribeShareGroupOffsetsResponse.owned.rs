...
impl<'de> Decode<'de> for DescribeShareGroupOffsetsResponse {
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.groups = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(DescribeShareGroupOffsetsResponseGroup::decode(buf, version)?); } v }; }
        if flex {
...
impl<'de> Decode<'de> for DescribeShareGroupOffsetsResponseGroup {
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.topics = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(DescribeShareGroupOffsetsResponseTopic::decode(buf, version)?); } v }; }
...
impl<'de> Decode<'de> for DescribeShareGroupOffsetsResponseTopic {
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.partitions = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(DescribeShareGroupOffsetsResponsePartition::decode(buf, version)?); } v }; }
        if flex {
            out.unknown_tagged_fields = read_tagged_fields(buf, |_tag, _payload| {
                Ok(false)
            })?;
...
impl Encode for DescribeShareGroupOffsetsResponsePartition {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        ...
        if version >= 1 { put_i64(buf, self.lag) }
        if version >= 0 { put_i16(buf, self.error_code) }
        if version >= 0 { if flex { put_compact_nullable_string(buf, self.error_message.as_deref()) } else { put_nullable_string(buf, self.error_message.as_deref()) } }
        if flex {
            let tagged = WriteTaggedFields::new();
...
impl<'de> Decode<'de> for DescribeShareGroupOffsetsResponsePartition {
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 1 { out.lag = get_i64(buf)?; }
        if version >= 0 { out.error_code = get_i16(buf)?; }
        if version >= 0 { out.error_message = if flex { get_compact_nullable_string_owned(buf)? } else { get_nullable_string_owned(buf)? }; }
        if flex {
            out.unknown_tagged_fields = read_tagged_fields(buf, |_tag, _payload| {
