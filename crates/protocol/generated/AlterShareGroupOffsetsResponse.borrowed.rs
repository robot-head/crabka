...
impl AlterShareGroupOffsetsResponse<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::alter_share_group_offsets_response::AlterShareGroupOffsetsResponse {
        crate::owned::alter_share_group_offsets_response::AlterShareGroupOffsetsResponse {
            ...
            responses: (self.responses).iter().map(AlterShareGroupOffsetsResponseTopic::to_owned).collect(),
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.responses = {
                ...
                for _ in 0..n {
                    v.push(AlterShareGroupOffsetsResponseTopic::decode_borrow(buf, version)?);
                }
                v
            };
        }
...
impl AlterShareGroupOffsetsResponseTopic<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::alter_share_group_offsets_response::AlterShareGroupOffsetsResponseTopic {
        crate::owned::alter_share_group_offsets_response::AlterShareGroupOffsetsResponseTopic {
            ...
            partitions: (self.partitions).iter().map(AlterShareGroupOffsetsResponsePartition::to_owned).collect(),
            unknown_tagged_fields: self.unknown_tagged_fields.clone(),
        }
    }
}
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.partitions = {
                ...
                let mut v = Vec::with_capacity(n);
                for _ in 0..n {
                    v.push(AlterShareGroupOffsetsResponsePartition::decode_borrow(buf, version)?);
                }
                v
            };
        }
