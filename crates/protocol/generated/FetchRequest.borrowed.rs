...
use crate::primitives::string_bytes::{compact_nullable_string_len, compact_string_len, nullable_string_len, put_compact_nullable_string, put_compact_string, put_nullable_string, put_string, string_len};
...
impl<'a> FetchRequest<'a> {
    ...
    pub fn to_owned(&self) -> crate::owned::fetch_request::FetchRequest {
        crate::owned::fetch_request::FetchRequest {
            ...
            forgotten_topics_data: (self.forgotten_topics_data).iter().map(ForgottenTopic::to_owned).collect(),
    ...
    fn encode_field_8<B: BufMut>(&self, buf: &mut B, version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 7 {
            {
                crate::primitives::array::put_array_len(buf, (self.forgotten_topics_data).len(), flex);
    ...
    fn encode_field_9<B: BufMut>(&self, buf: &mut B, version: i16, flex: bool) {
        if version >= 11 {
            if flex { put_compact_string(buf, self.rack_id) } else { put_string(buf, self.rack_id) }
        }
    }
    ...
    fn decode_field_0(out: &mut Self, buf: &mut &'a [u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if (0..=14).contains(&version) {
            out.replica_id = get_i32(buf)?;
        }
        Ok(())
    }
    fn decode_field_1(out: &mut Self, buf: &mut &'a [u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.max_wait_ms = get_i32(buf)?;
        }
        Ok(())
    }
    fn decode_field_2(out: &mut Self, buf: &mut &'a [u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.min_bytes = get_i32(buf)?;
        }
        Ok(())
    }
    fn decode_field_3(out: &mut Self, buf: &mut &'a [u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 3 {
            out.max_bytes = get_i32(buf)?;
        }
        Ok(())
    }
    fn decode_field_4(out: &mut Self, buf: &mut &'a [u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 4 {
            out.isolation_level = get_i8(buf)?;
        }
        Ok(())
    }
    fn decode_field_5(out: &mut Self, buf: &mut &'a [u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 7 {
            out.session_id = get_i32(buf)?;
        }
        Ok(())
    }
    fn decode_field_6(out: &mut Self, buf: &mut &'a [u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 7 {
            out.session_epoch = get_i32(buf)?;
        }
        Ok(())
    }
    fn decode_field_7(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.topics = {
    ...
    fn decode_field_8(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 7 {
    ...
    fn decode_field_9(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 11 {
            out.rack_id = if flex { get_compact_string_borrowed(buf)? } else { get_string_borrowed(buf)? };
        }
        Ok(())
    }
...
impl Encode for FetchRequest<'_> {
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 7 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.forgotten_topics_data).len(), flex);
                let body: usize = (self.forgotten_topics_data).iter().map(|it| it.encoded_len(version)).sum();
                prefix + body
            };
        }
        if version >= 11 {
            n += if flex { compact_string_len(self.rack_id) } else { string_len(self.rack_id) };
        }
        if flex {
...
impl FetchTopic<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::fetch_request::FetchTopic {
        crate::owned::fetch_request::FetchTopic {
            ...
            partitions: (self.partitions).iter().map(FetchPartition::to_owned).collect(),
            unknown_tagged_fields: self.unknown_tagged_fields.clone(),
        }
    }
}
...
impl<'de> DecodeBorrow<'de> for FetchTopic<'de> {
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        let mut out = Self::default();
        if (0..=12).contains(&version) {
            out.topic = if flex { get_compact_string_borrowed(buf)? } else { get_string_borrowed(buf)? };
        }
        if version >= 13 {
...
impl FetchPartition {
    ...
    fn decode_field_0(out: &mut Self, buf: &mut &[u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.partition = get_i32(buf)?;
        }
        Ok(())
    }
    fn decode_field_1(out: &mut Self, buf: &mut &[u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 9 {
            out.current_leader_epoch = get_i32(buf)?;
        }
        Ok(())
    }
    fn decode_field_2(out: &mut Self, buf: &mut &[u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.fetch_offset = get_i64(buf)?;
        }
        Ok(())
    }
    fn decode_field_3(out: &mut Self, buf: &mut &[u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 12 {
            out.last_fetched_epoch = get_i32(buf)?;
        }
        Ok(())
    }
    fn decode_field_4(out: &mut Self, buf: &mut &[u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 5 {
            out.log_start_offset = get_i64(buf)?;
        }
        Ok(())
    }
    fn decode_field_5(out: &mut Self, buf: &mut &[u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.partition_max_bytes = get_i32(buf)?;
        }
        Ok(())
    }
    fn decode_tagged_fields(out: &mut Self, buf: &mut &[u8], _version: i16, flex: bool) -> Result<(), ProtocolError> {
        if flex {
