...
impl<'a> Default for InitializeShareGroupStateResponse<'a> {
    fn default() -> Self {
        Self {
            results: Vec::new(),
...
impl<'a> InitializeShareGroupStateResponse<'a> {
    pub fn to_owned(&self) -> crate::owned::initialize_share_group_state_response::InitializeShareGroupStateResponse {
...
impl<'a> Encode for InitializeShareGroupStateResponse<'a> {
...
impl<'de> DecodeBorrow<'de> for InitializeShareGroupStateResponse<'de> {
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.results = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(InitializeStateResult::decode_borrow(buf, version)?); } v }; }
        if flex {
...
impl<'a> Default for InitializeStateResult<'a> {
    fn default() -> Self {
        Self {
...
impl<'a> InitializeStateResult<'a> {
    pub fn to_owned(&self) -> crate::owned::initialize_share_group_state_response::InitializeStateResult {
...
impl<'a> Encode for InitializeStateResult<'a> {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        let flex = version >= 0;
