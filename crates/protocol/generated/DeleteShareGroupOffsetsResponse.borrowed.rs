...
impl DeleteShareGroupOffsetsResponse<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::delete_share_group_offsets_response::DeleteShareGroupOffsetsResponse {
        crate::owned::delete_share_group_offsets_response::DeleteShareGroupOffsetsResponse {
            ...
            responses: (self.responses).iter().map(DeleteShareGroupOffsetsResponseTopic::to_owned).collect(),
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.responses = {
                ...
                for _ in 0..n {
                    v.push(DeleteShareGroupOffsetsResponseTopic::decode_borrow(buf, version)?);
                }
                v
            };
        }
...
impl DeleteShareGroupOffsetsResponse<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.responses = vec![DeleteShareGroupOffsetsResponseTopic::populated(version)];
        }
        m
    }
}
...
impl DeleteShareGroupOffsetsResponseTopic<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::delete_share_group_offsets_response::DeleteShareGroupOffsetsResponseTopic {
