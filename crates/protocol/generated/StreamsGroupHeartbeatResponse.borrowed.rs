...
pub struct StreamsGroupHeartbeatResponse<'a> {
    ...
    pub active_tasks: Option<Vec<super::common::streams_group_heartbeat_response::task_ids::TaskIds<'a>>>,
    pub standby_tasks: Option<Vec<super::common::streams_group_heartbeat_response::task_ids::TaskIds<'a>>>,
    pub warmup_tasks: Option<Vec<super::common::streams_group_heartbeat_response::task_ids::TaskIds<'a>>>,
...
impl StreamsGroupHeartbeatResponse<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.status = Some(vec![super::common::streams_group_heartbeat_response::status::Status::populated(version)]);
        }
        if version >= 0 {
            m.active_tasks = Some(vec![super::common::streams_group_heartbeat_response::task_ids::TaskIds::populated(version)]);
        }
        if version >= 0 {
            m.standby_tasks = Some(vec![super::common::streams_group_heartbeat_response::task_ids::TaskIds::populated(version)]);
        }
        if version >= 0 {
            m.warmup_tasks = Some(vec![super::common::streams_group_heartbeat_response::task_ids::TaskIds::populated(version)]);
        }
        if version >= 0 {
...
pub struct EndpointToPartitions<'a> {
    ...
    pub active_partitions: Vec<super::common::streams_group_heartbeat_response::topic_partition::TopicPartition<'a>>,
    pub standby_partitions: Vec<super::common::streams_group_heartbeat_response::topic_partition::TopicPartition<'a>>,
    pub unknown_tagged_fields: UnknownTaggedFields,
}
...
impl Encode for EndpointToPartitions<'_> {
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.active_partitions).len(), flex);
                let body: usize = (self.active_partitions).iter().map(|it| it.encoded_len(version)).sum();
                prefix + body
            };
        }
        if version >= 0 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.standby_partitions).len(), flex);
                let body: usize = (self.standby_partitions).iter().map(|it| it.encoded_len(version)).sum();
                prefix + body
            };
        }
        if flex {
...
impl<'de> DecodeBorrow<'de> for EndpointToPartitions<'de> {
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        let mut out = Self::default();
        if version >= 0 {
            out.user_endpoint = super::common::streams_group_heartbeat_response::endpoint::Endpoint::decode_borrow(buf, version)?;
        }
        if version >= 0 {
...
impl EndpointToPartitions<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        let mut m = Self::default();
        if version >= 0 {
            m.user_endpoint = super::common::streams_group_heartbeat_response::endpoint::Endpoint::populated(version);
        }
        if version >= 0 {
