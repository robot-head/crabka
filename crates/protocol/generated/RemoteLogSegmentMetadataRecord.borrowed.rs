...
impl<'a> Default for RemoteLogSegmentMetadataRecord<'a> {
    fn default() -> Self {
        Self {
            ...
            segment_leader_epochs: Vec::new(),
            segment_size_in_bytes: 0i32,
...
impl<'a> Encode for RemoteLogSegmentMetadataRecord<'a> {
...
impl Default for SegmentLeaderEpochEntry {
    fn default() -> Self {
        Self {
            leader_epoch: 0i32,
            offset: 0i64,
