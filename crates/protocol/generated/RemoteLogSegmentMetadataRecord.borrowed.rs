...
use crate::primitives::fixed::{get_bool, get_i8, get_i32, get_i64, put_bool, put_i8, put_i32, put_i64};
use crate::primitives::string_bytes::{compact_string_len, put_compact_string, put_string, string_len};
...
impl<'a> RemoteLogSegmentMetadataRecord<'a> {
    pub fn to_owned(&self) -> crate::owned::remote_log_segment_metadata_record::RemoteLogSegmentMetadataRecord {
    ...
    fn encode_field_0<B: BufMut>(&self, buf: &mut B, version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
    ...
    fn encode_field_6<B: BufMut>(&self, buf: &mut B, version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            {
                crate::primitives::array::put_array_len(buf, (self.segment_leader_epochs).len(), flex);
    ...
    fn encode_field_8<B: BufMut>(&self, buf: &mut B, version: i16, flex: bool) {
        if version >= 0 {
            if flex { put_compact_nullable_bytes(buf, self.custom_metadata) } else { put_nullable_bytes(buf, self.custom_metadata) }
        }
    }
    ...
    fn decode_field_8(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.custom_metadata = if flex { get_compact_nullable_bytes_borrowed(buf)? } else { get_nullable_bytes_borrowed(buf)? };
        }
        Ok(())
    }
...
impl Encode for RemoteLogSegmentMetadataRecord<'_> {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        if !(MIN_VERSION..=MAX_VERSION).contains(&version) {
            return Err(ProtocolError::SchemaMismatch("RemoteLogSegmentMetadataRecord version out of range"));
        }
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.segment_leader_epochs).len(), flex);
                let body: usize = (self.segment_leader_epochs).iter().map(|it| it.encoded_len(version)).sum();
                prefix + body
            };
        }
        if version >= 0 {
...
impl RemoteLogSegmentIdEntry<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::remote_log_segment_metadata_record::RemoteLogSegmentIdEntry {
...
impl TopicIdPartitionEntry<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::remote_log_segment_metadata_record::TopicIdPartitionEntry {
...
impl SegmentLeaderEpochEntry {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::remote_log_segment_metadata_record::SegmentLeaderEpochEntry {
