...
impl RemoteLogSegmentMetadataUpdateRecord<'_> {
    pub fn to_owned(&self) -> crate::owned::remote_log_segment_metadata_update_record::RemoteLogSegmentMetadataUpdateRecord {
...
impl Encode for RemoteLogSegmentMetadataUpdateRecord<'_> {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        if !(MIN_VERSION..=MAX_VERSION).contains(&version) {
            return Err(ProtocolError::SchemaMismatch("RemoteLogSegmentMetadataUpdateRecord version out of range"));
        }
...
impl RemoteLogSegmentIdEntry<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::remote_log_segment_metadata_update_record::RemoteLogSegmentIdEntry {
...
impl TopicIdPartitionEntry<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::remote_log_segment_metadata_update_record::TopicIdPartitionEntry {
