...
impl DescribeShareGroupOffsetsResponse<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::describe_share_group_offsets_response::DescribeShareGroupOffsetsResponse {
        crate::owned::describe_share_group_offsets_response::DescribeShareGroupOffsetsResponse {
            ...
            groups: (self.groups).iter().map(DescribeShareGroupOffsetsResponseGroup::to_owned).collect(),
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.groups = {
                ...
                for _ in 0..n {
                    v.push(DescribeShareGroupOffsetsResponseGroup::decode_borrow(buf, version)?);
                }
                v
            };
        }
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.topics = {
                ...
                let mut v = Vec::with_capacity(n);
                for _ in 0..n {
                    v.push(DescribeShareGroupOffsetsResponseTopic::decode_borrow(buf, version)?);
                }
                v
            };
        }
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.partitions = {
                ...
                let mut v = Vec::with_capacity(n);
                for _ in 0..n {
                    v.push(DescribeShareGroupOffsetsResponsePartition::decode_borrow(buf, version)?);
                }
                v
            };
        }
