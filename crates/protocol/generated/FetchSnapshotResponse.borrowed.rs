    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.topics = {
                ...
                for _ in 0..n {
                    v.push(TopicSnapshot::decode_borrow(buf, version)?);
                }
                v
            };
        }
                ...
                0 => {
                    tag_node_endpoints = Some({
                        let b: &mut &[u8] = payload;
                        {
                            ...
                            let mut v = Vec::with_capacity(n);
                            for _ in 0..n {
                                v.push(crate::owned::fetch_snapshot_response::NodeEndpoint::decode(b, version)?);
                            }
                            v
                        }
                    });
...
impl FetchSnapshotResponse<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.topics = vec![TopicSnapshot::populated(version)];
        }
        if version >= 1 {
            m.node_endpoints = vec![crate::owned::fetch_snapshot_response::NodeEndpoint::populated(version)];
        }
        m
    }
}
...
impl TopicSnapshot<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::fetch_snapshot_response::TopicSnapshot {
        crate::owned::fetch_snapshot_response::TopicSnapshot {
            ...
            partitions: (self.partitions).iter().map(PartitionSnapshot::to_owned).collect(),
            unknown_tagged_fields: self.unknown_tagged_fields.clone(),
        }
    }
}
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.partitions = {
                ...
                let mut v = Vec::with_capacity(n);
                for _ in 0..n {
                    v.push(PartitionSnapshot::decode_borrow(buf, version)?);
                }
                v
            };
        }
...
impl TopicSnapshot<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.partitions = vec![PartitionSnapshot::populated(version)];
        }
        m
    }
}
...
impl Encode for PartitionSnapshot<'_> {
        ...
        if version >= 0 {
            {
                ...
                <crate::records::RecordsPayloadBorrowed as crate::Encode>::encode(&self.unaligned_records, &mut __rb_buf, version)?;
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 {
            n += self.snapshot_id.encoded_len(version);
        }
        if version >= 0 {
            n += 8;
        }
        ...
        if version >= 0 {
            n += {
                let __rb_len = <crate::records::RecordsPayloadBorrowed as crate::Encode>::encoded_len(&(self.unaligned_records), version);
...
impl<'de> DecodeBorrow<'de> for PartitionSnapshot<'de> {
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.snapshot_id = SnapshotId::decode_borrow(buf, version)?;
        }
        if version >= 0 {
            out.size = get_i64(buf)?;
        }
        if version >= 0 {
            out.position = get_i64(buf)?;
        }
        if version >= 0 {
            out.unaligned_records = {
