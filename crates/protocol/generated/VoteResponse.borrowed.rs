...
impl Encode for VoteResponse<'_> {
                ...
                0 => {
                    tag_node_endpoints = Some({
                        let b: &mut &[u8] = payload;
                        {
                            ...
                            let mut v = Vec::with_capacity(n);
                            for _ in 0..n {
                                v.push(crate::owned::vote_response::NodeEndpoint::decode(b, version)?);
                            }
                            v
                        }
                    });
...
impl VoteResponse<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 1 {
            m.node_endpoints = vec![crate::owned::vote_response::NodeEndpoint::populated(version)];
        }
        m
    }
}
