...
impl<'a> Default for CreateAclsResponse<'a> {
    fn default() -> Self {
        Self {
...
impl<'a> Encode for CreateAclsResponse<'a> {
...
impl<'de> DecodeBorrow<'de> for CreateAclsResponse<'de> {
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.results = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(AclCreationResult::decode_borrow(buf, version)?); } v }; }
        if flex {
...
impl<'a> Default for AclCreationResult<'a> {
    fn default() -> Self {
        Self {
            error_code: 0i16,
            error_message: None,
...
impl<'a> Encode for AclCreationResult<'a> {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        let flex = version >= 2;
