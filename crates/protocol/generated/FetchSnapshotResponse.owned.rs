...
impl Encode for PartitionSnapshot {
        ...
        if version >= 0 {
            {
                ...
                <crate::records::RecordsPayload as crate::Encode>::encode(&self.unaligned_records, &mut __rb_buf, version)?;
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 {
            n += {
                let __rb_len = <crate::records::RecordsPayload as crate::Encode>::encoded_len(&self.unaligned_records, version);
