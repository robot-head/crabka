    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.topic_partitions = {
                ...
                for _ in 0..n {
                    v.push(
                        super::common::share_group_heartbeat_response::topic_partitions::TopicPartitions::decode_borrow(
                            buf,
                            version,
                        )?,
                    );
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.topic_partitions = vec![
                super::common::share_group_heartbeat_response::topic_partitions::TopicPartitions::populated(version)
            ];
        }
        m
    }
