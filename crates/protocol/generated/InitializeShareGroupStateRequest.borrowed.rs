...
impl<'a> InitializeShareGroupStateRequest<'a> {
    pub fn to_owned(&self) -> crate::owned::initialize_share_group_state_request::InitializeShareGroupStateRequest {
...
impl<'de> DecodeBorrow<'de> for InitializeShareGroupStateRequest<'de> {
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.topics = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(InitializeStateData::decode_borrow(buf, version)?); } v }; }
        if flex {
...
impl InitializeStateData {
    pub fn to_owned(&self) -> crate::owned::initialize_share_group_state_request::InitializeStateData {
