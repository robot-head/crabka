                ...
                0 => {
                    tag_node_endpoints = Some({
                        let b: &mut &[u8] = payload;
                        {
                            ...
                            let mut v = Vec::with_capacity(n);
                            for _ in 0..n {
                                v.push(crate::owned::end_quorum_epoch_response::NodeEndpoint::decode(b, version)?);
                            }
                            v
                        }
                    });
...
impl EndQuorumEpochResponse<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 1 {
            m.node_endpoints = vec![crate::owned::end_quorum_epoch_response::NodeEndpoint::populated(version)];
        }
        m
    }
}
