...
use crate::primitives::string_bytes::{compact_string_len, get_compact_string_owned, get_string_owned, put_compact_string, put_string, string_len};
...
impl RemoteLogSegmentMetadataRecord {
    ...
    fn decode_field_8<B: Buf>(out: &mut Self, buf: &mut B, version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.custom_metadata = if flex { get_compact_nullable_bytes_owned(buf)? } else { get_nullable_bytes_owned(buf)? };
        }
        Ok(())
    }
...
pub fn default_json(_version: i16) -> ::serde_json::Value {
    ...
    obj.insert("remoteLogSegmentId".to_string(), {
        ...
        m.insert("topicIdPartition".to_string(), {
            ...
            m.insert("id".to_string(), ::serde_json::Value::String("AAAAAAAAAAAAAAAAAAAAAA".to_string()));
    ...
    obj.insert("segmentLeaderEpochs".to_string(), ::serde_json::Value::Array(vec![]));
    ...
    obj.insert("txnIndexEmpty".to_string(), ::serde_json::Value::Bool(false));
