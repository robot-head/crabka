...
impl DeleteGroupsResponse<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::delete_groups_response::DeleteGroupsResponse {
        crate::owned::delete_groups_response::DeleteGroupsResponse {
            ...
            results: (self.results).iter().map(DeletableGroupResult::to_owned).collect(),
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.results = {
                ...
                for _ in 0..n {
                    v.push(DeletableGroupResult::decode_borrow(buf, version)?);
                }
                v
            };
        }
...
impl DeleteGroupsResponse<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.results = vec![DeletableGroupResult::populated(version)];
        }
        m
    }
}
