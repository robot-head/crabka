...
impl ShareGroupDescribeResponse<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::share_group_describe_response::ShareGroupDescribeResponse {
...
impl Member<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.assignment = super::common::share_group_describe_response::assignment::Assignment::populated(version);
        }
        m
    }
}
