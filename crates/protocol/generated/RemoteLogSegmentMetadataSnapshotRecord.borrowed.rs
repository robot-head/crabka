...
impl Encode for RemoteLogSegmentMetadataSnapshotRecord<'_> {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        if !(MIN_VERSION..=MAX_VERSION).contains(&version) {
            return Err(ProtocolError::SchemaMismatch("RemoteLogSegmentMetadataSnapshotRecord version out of range"));
        }
...
impl SegmentLeaderEpochEntry {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::remote_log_segment_metadata_snapshot_record::SegmentLeaderEpochEntry {
