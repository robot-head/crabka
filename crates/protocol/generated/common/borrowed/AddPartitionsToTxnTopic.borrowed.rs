...
impl<'a> AddPartitionsToTxnTopic<'a> {
    pub fn to_owned(&self) -> crate::owned::common::add_partitions_to_txn_topic::AddPartitionsToTxnTopic {
        crate::owned::common::add_partitions_to_txn_topic::AddPartitionsToTxnTopic {
