...
impl WriteTxnMarkersResponse<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::write_txn_markers_response::WriteTxnMarkersResponse {
        crate::owned::write_txn_markers_response::WriteTxnMarkersResponse {
            markers: (self.markers).iter().map(WritableTxnMarkerResult::to_owned).collect(),
...
impl Encode for WriteTxnMarkersResponse<'_> {
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.markers).len(), flex);
                let body: usize = (self.markers).iter().map(|it| it.encoded_len(version)).sum();
                prefix + body
            };
        }
        if flex {
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.markers = {
                ...
                for _ in 0..n {
                    v.push(WritableTxnMarkerResult::decode_borrow(buf, version)?);
                }
                v
            };
        }
...
impl WriteTxnMarkersResponse<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.markers = vec![WritableTxnMarkerResult::populated(version)];
        }
        m
    }
}
...
impl WritableTxnMarkerResult<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::write_txn_markers_response::WritableTxnMarkerResult {
        crate::owned::write_txn_markers_response::WritableTxnMarkerResult {
            ...
            topics: (self.topics).iter().map(WritableTxnMarkerTopicResult::to_owned).collect(),
            unknown_tagged_fields: self.unknown_tagged_fields.clone(),
        }
    }
}
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.topics = {
                ...
                let mut v = Vec::with_capacity(n);
                for _ in 0..n {
                    v.push(WritableTxnMarkerTopicResult::decode_borrow(buf, version)?);
                }
                v
            };
        }
...
impl WritableTxnMarkerResult<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.topics = vec![WritableTxnMarkerTopicResult::populated(version)];
        }
        m
    }
}
...
impl WritableTxnMarkerTopicResult<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::write_txn_markers_response::WritableTxnMarkerTopicResult {
        crate::owned::write_txn_markers_response::WritableTxnMarkerTopicResult {
            name: (self.name).to_string(),
            partitions: (self.partitions).iter().map(WritableTxnMarkerPartitionResult::to_owned).collect(),
            unknown_tagged_fields: self.unknown_tagged_fields.clone(),
        }
    }
}
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.partitions = {
                ...
                let mut v = Vec::with_capacity(n);
                for _ in 0..n {
                    v.push(WritableTxnMarkerPartitionResult::decode_borrow(buf, version)?);
                }
                v
            };
        }
...
impl WritableTxnMarkerTopicResult<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.partitions = vec![WritableTxnMarkerPartitionResult::populated(version)];
        }
        m
    }
}
...
impl WritableTxnMarkerPartitionResult {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::write_txn_markers_response::WritableTxnMarkerPartitionResult {
...
impl Encode for WritableTxnMarkerPartitionResult {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        let flex = version >= 1;
        if version >= 0 {
