...
impl Encode for ReadShareGroupStateRequest {
...
impl<'de> Decode<'de> for ReadShareGroupStateRequest {
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.topics = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(ReadStateData::decode(buf, version)?); } v }; }
        if flex {
...
impl crate::ProtocolRequest for ReadShareGroupStateRequest {
    ...
    type Response = super::read_share_group_state_response::ReadShareGroupStateResponse;
}
