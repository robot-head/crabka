...
impl DeleteShareGroupOffsetsRequest<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::delete_share_group_offsets_request::DeleteShareGroupOffsetsRequest {
        crate::owned::delete_share_group_offsets_request::DeleteShareGroupOffsetsRequest {
            group_id: (self.group_id).to_string(),
            topics: (self.topics).iter().map(DeleteShareGroupOffsetsRequestTopic::to_owned).collect(),
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.topics = {
                ...
                for _ in 0..n {
                    v.push(DeleteShareGroupOffsetsRequestTopic::decode_borrow(buf, version)?);
                }
                v
            };
        }
...
impl DeleteShareGroupOffsetsRequest<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.topics = vec![DeleteShareGroupOffsetsRequestTopic::populated(version)];
        }
        m
    }
}
...
impl DeleteShareGroupOffsetsRequestTopic<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::delete_share_group_offsets_request::DeleteShareGroupOffsetsRequestTopic {
