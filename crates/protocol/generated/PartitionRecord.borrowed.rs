...
impl PartitionRecord {
    ...
    fn decode_field_2(out: &mut Self, buf: &mut &[u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.replicas = {
    ...
    fn decode_field_3(out: &mut Self, buf: &mut &[u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.isr = {
                let n = crate::primitives::array::get_array_len(buf, flex)?;
                let mut v = Vec::with_capacity(n);
    ...
    fn decode_field_4(out: &mut Self, buf: &mut &[u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
    ...
    fn decode_field_5(out: &mut Self, buf: &mut &[u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.adding_replicas = {
                let n = crate::primitives::array::get_array_len(buf, flex)?;
                let mut v = Vec::with_capacity(n);
    ...
    fn decode_field_6(out: &mut Self, buf: &mut &[u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.leader = get_i32(buf)?;
        }
        Ok(())
    }
    fn decode_field_7(out: &mut Self, buf: &mut &[u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.leader_epoch = get_i32(buf)?;
        }
        Ok(())
    }
    fn decode_field_8(out: &mut Self, buf: &mut &[u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.partition_epoch = get_i32(buf)?;
        }
        Ok(())
    }
    fn decode_field_9(out: &mut Self, buf: &mut &[u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 1 {
            out.directories = {
                let n = crate::primitives::array::get_array_len(buf, flex)?;
                let mut v = Vec::with_capacity(n);
...
impl Encode for PartitionRecord {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        if !(MIN_VERSION..=MAX_VERSION).contains(&version) {
            return Err(ProtocolError::SchemaMismatch("PartitionRecord version out of range"));
        }
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.replicas).len(), flex);
        ...
        if version >= 0 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.removing_replicas).len(), flex);
        ...
        if version >= 0 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.adding_replicas).len(), flex);
