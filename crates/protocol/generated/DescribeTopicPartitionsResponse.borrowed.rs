...
impl DescribeTopicPartitionsResponse<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::describe_topic_partitions_response::DescribeTopicPartitionsResponse {
        crate::owned::describe_topic_partitions_response::DescribeTopicPartitionsResponse {
            throttle_time_ms: (self.throttle_time_ms),
            topics: (self.topics).iter().map(DescribeTopicPartitionsResponseTopic::to_owned).collect(),
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.topics = {
                ...
                for _ in 0..n {
                    v.push(DescribeTopicPartitionsResponseTopic::decode_borrow(buf, version)?);
                }
                v
            };
        }
        if version >= 0 {
            out.next_cursor = if get_i8(buf)? < 0 { None } else { Some(Cursor::decode_borrow(buf, version)?) };
        }
        if flex {
...
impl DescribeTopicPartitionsResponseTopic<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::describe_topic_partitions_response::DescribeTopicPartitionsResponseTopic {
        crate::owned::describe_topic_partitions_response::DescribeTopicPartitionsResponseTopic {
            ...
            partitions: (self.partitions).iter().map(DescribeTopicPartitionsResponsePartition::to_owned).collect(),
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.partitions = {
                ...
                let mut v = Vec::with_capacity(n);
                for _ in 0..n {
                    v.push(DescribeTopicPartitionsResponsePartition::decode_borrow(buf, version)?);
                }
                v
            };
        }
...
impl DescribeTopicPartitionsResponsePartition {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::describe_topic_partitions_response::DescribeTopicPartitionsResponsePartition {
    ...
    fn decode_field_6(out: &mut Self, buf: &mut &[u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
    ...
    fn decode_field_7(out: &mut Self, buf: &mut &[u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.last_known_elr = {
                let opt = crate::primitives::array::get_nullable_array_len(buf, flex)?;
                match opt {
    ...
    fn decode_field_8(out: &mut Self, buf: &mut &[u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
