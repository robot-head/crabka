...
impl<'de> Decode<'de> for OffsetDeleteResponse {
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.topics = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(OffsetDeleteResponseTopic::decode(buf, version)?); } v }; }
        Ok(out)
    }
}
...
impl<'de> Decode<'de> for OffsetDeleteResponseTopic {
    fn decode<B: Buf>(buf: &mut B, version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.partitions = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(OffsetDeleteResponsePartition::decode(buf, version)?); } v }; }
        Ok(out)
    }
}
...
pub fn default_json() -> ::serde_json::Value {
    ::serde_json::json!({"ErrorCode": 0, "ThrottleTimeMs": 0, "Topics": []})
}
