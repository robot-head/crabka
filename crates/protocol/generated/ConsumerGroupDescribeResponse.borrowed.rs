...
use crate::primitives::string_bytes_borrowed::{get_compact_nullable_string_borrowed, get_compact_string_borrowed, get_nullable_string_borrowed, get_string_borrowed};
...
impl<'a> DescribedGroup<'a> {
    ...
    fn encode_field_1<B: BufMut>(&self, buf: &mut B, version: i16, flex: bool) {
        if version >= 0 {
            if flex { put_compact_nullable_string(buf, self.error_message) } else { put_nullable_string(buf, self.error_message) }
        }
    }
    ...
    fn decode_field_1(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.error_message = if flex { get_compact_nullable_string_borrowed(buf)? } else { get_nullable_string_borrowed(buf)? };
        }
        Ok(())
    }
    fn decode_field_2(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.group_id = if flex { get_compact_string_borrowed(buf)? } else { get_string_borrowed(buf)? };
        }
        Ok(())
    }
    fn decode_field_3(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.group_state = if flex { get_compact_string_borrowed(buf)? } else { get_string_borrowed(buf)? };
        }
        Ok(())
    }
    ...
    fn decode_field_6(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.assignor_name = if flex { get_compact_string_borrowed(buf)? } else { get_string_borrowed(buf)? };
        }
        Ok(())
    }
    ...
    fn decode_field_8(out: &mut Self, buf: &mut &'a [u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
...
impl Encode for DescribedGroup<'_> {
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 {
            n += if flex { compact_nullable_string_len(self.error_message) } else { nullable_string_len(self.error_message) };
        }
        if version >= 0 {
...
pub struct Member<'a> {
    ...
    pub target_assignment: super::common::consumer_group_describe_response::assignment::Assignment<'a>,
    pub member_type: i8,
    pub unknown_tagged_fields: UnknownTaggedFields,
}
impl<'a> Default for Member<'a> {
    fn default() -> Self {
        Self {
            ...
            assignment: <super::common::consumer_group_describe_response::assignment::Assignment<'a>>::default(),
            target_assignment: <super::common::consumer_group_describe_response::assignment::Assignment<'a>>::default(),
            member_type: -1i8,
            unknown_tagged_fields: UnknownTaggedFields::default(),
        }
    }
...
impl<'a> Member<'a> {
    ...
    pub fn to_owned(&self) -> crate::owned::consumer_group_describe_response::Member {
        crate::owned::consumer_group_describe_response::Member {
            ...
            subscribed_topic_names: (self.subscribed_topic_names).iter().map(std::string::ToString::to_string).collect(),
            subscribed_topic_regex: (self.subscribed_topic_regex).map(std::string::ToString::to_string),
    ...
    fn encode_field_1<B: BufMut>(&self, buf: &mut B, version: i16, flex: bool) {
        if version >= 0 {
            if flex { put_compact_nullable_string(buf, self.instance_id) } else { put_nullable_string(buf, self.instance_id) }
        }
    }
    fn encode_field_2<B: BufMut>(&self, buf: &mut B, version: i16, flex: bool) {
        if version >= 0 {
            if flex { put_compact_nullable_string(buf, self.rack_id) } else { put_nullable_string(buf, self.rack_id) }
        }
    }
    ...
    fn decode_field_0(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.member_id = if flex { get_compact_string_borrowed(buf)? } else { get_string_borrowed(buf)? };
        }
        Ok(())
    }
    fn decode_field_1(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.instance_id = if flex { get_compact_nullable_string_borrowed(buf)? } else { get_nullable_string_borrowed(buf)? };
        }
        Ok(())
    }
    fn decode_field_2(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.rack_id = if flex { get_compact_nullable_string_borrowed(buf)? } else { get_nullable_string_borrowed(buf)? };
        }
        Ok(())
    }
    ...
    fn decode_field_4(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.client_id = if flex { get_compact_string_borrowed(buf)? } else { get_string_borrowed(buf)? };
        }
        Ok(())
    }
    fn decode_field_5(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.client_host = if flex { get_compact_string_borrowed(buf)? } else { get_string_borrowed(buf)? };
        }
        Ok(())
    }
    fn decode_field_6(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.subscribed_topic_names = {
                ...
                let mut v = Vec::with_capacity(n);
                for _ in 0..n {
                    v.push(if flex { get_compact_string_borrowed(buf)? } else { get_string_borrowed(buf)? });
                }
                v
            };
        }
    ...
    fn decode_field_7(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.subscribed_topic_regex = if flex { get_compact_nullable_string_borrowed(buf)? } else { get_nullable_string_borrowed(buf)? };
        }
        Ok(())
    }
    fn decode_field_8(out: &mut Self, buf: &mut &'a [u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
    ...
    fn decode_field_9(out: &mut Self, buf: &mut &'a [u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.target_assignment = super::common::consumer_group_describe_response::assignment::Assignment::decode_borrow(buf, version)?;
        }
        Ok(())
    }
    fn decode_field_10(out: &mut Self, buf: &mut &'a [u8], version: i16, _flex: bool) -> Result<(), ProtocolError> {
        if version >= 1 {
...
impl Encode for Member<'_> {
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 {
            n += if flex { compact_nullable_string_len(self.instance_id) } else { nullable_string_len(self.instance_id) };
        }
        if version >= 0 {
            n += if flex { compact_nullable_string_len(self.rack_id) } else { nullable_string_len(self.rack_id) };
        }
        if version >= 0 {
            n += 4;
        }
