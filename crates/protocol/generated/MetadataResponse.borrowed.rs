...
impl MetadataResponse<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::metadata_response::MetadataResponse {
        crate::owned::metadata_response::MetadataResponse {
            ...
            brokers: (self.brokers).iter().map(MetadataResponseBroker::to_owned).collect(),
            cluster_id: (self.cluster_id).map(std::string::ToString::to_string),
            controller_id: (self.controller_id),
            topics: (self.topics).iter().map(MetadataResponseTopic::to_owned).collect(),
...
impl Encode for MetadataResponse<'_> {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        ...
        if version >= 2 {
            if flex { put_compact_nullable_string(buf, self.cluster_id) } else { put_nullable_string(buf, self.cluster_id) }
        }
        if version >= 1 {
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.brokers).len(), flex);
                let body: usize = (self.brokers).iter().map(|it| it.encoded_len(version)).sum();
                prefix + body
            };
        }
        if version >= 2 {
            n += if flex { compact_nullable_string_len(self.cluster_id) } else { nullable_string_len(self.cluster_id) };
        }
        if version >= 1 {
            n += 4;
        }
...
impl<'de> DecodeBorrow<'de> for MetadataResponse<'de> {
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 2 {
            out.cluster_id = if flex { get_compact_nullable_string_borrowed(buf)? } else { get_nullable_string_borrowed(buf)? };
        }
        if version >= 1 {
...
impl MetadataResponseTopic<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::metadata_response::MetadataResponseTopic {
        crate::owned::metadata_response::MetadataResponseTopic {
            ...
            partitions: (self.partitions).iter().map(MetadataResponsePartition::to_owned).collect(),
...
impl Encode for MetadataResponseTopic<'_> {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        ...
        if version >= 0 {
            if version >= 12 {
                if flex { put_compact_nullable_string(buf, self.name) } else { put_nullable_string(buf, self.name) }
            } else {
                if flex { put_compact_string(buf, (self.name).unwrap_or("")) } else { put_string(buf, (self.name).unwrap_or("")) }
            }
        }
        if version >= 10 {
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 {
            n += if version >= 12 {
                if flex { compact_nullable_string_len(self.name) } else { nullable_string_len(self.name) }
            } else {
                if flex { compact_string_len((self.name).unwrap_or("")) } else { string_len((self.name).unwrap_or("")) }
            };
        }
        if version >= 10 {
            n += 16;
...
impl Encode for MetadataResponsePartition {
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.replica_nodes).len(), flex);
        ...
        if version >= 0 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.isr_nodes).len(), flex);
        ...
        if version >= 5 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.offline_replicas).len(), flex);
