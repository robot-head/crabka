...
impl WriteShareGroupStateResponse<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::write_share_group_state_response::WriteShareGroupStateResponse {
        crate::owned::write_share_group_state_response::WriteShareGroupStateResponse {
            results: (self.results).iter().map(WriteStateResult::to_owned).collect(),
    ...
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.results = {
                ...
                for _ in 0..n {
                    v.push(WriteStateResult::decode_borrow(buf, version)?);
                }
                v
            };
        }
...
impl WriteShareGroupStateResponse<'_> {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 0 {
            m.results = vec![WriteStateResult::populated(version)];
        }
        m
    }
}
