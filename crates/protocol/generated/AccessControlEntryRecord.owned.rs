...
impl Encode for AccessControlEntryRecord {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        if !(MIN_VERSION..=MAX_VERSION).contains(&version) {
            return Err(ProtocolError::SchemaMismatch("AccessControlEntryRecord version out of range"));
        }
...
pub fn default_json(_version: i16) -> ::serde_json::Value {
    ...
    obj.insert("id".to_string(), ::serde_json::Value::String("AAAAAAAAAAAAAAAAAAAAAA".to_string()));
    ...
    obj.insert("principal".to_string(), ::serde_json::Value::String(String::new()));
