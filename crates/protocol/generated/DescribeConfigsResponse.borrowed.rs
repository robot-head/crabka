...
use crate::primitives::fixed::{get_bool, get_i8, get_i16, get_i32, put_bool, put_i8, put_i16, put_i32};
...
impl DescribeConfigsResponse<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::describe_configs_response::DescribeConfigsResponse {
        crate::owned::describe_configs_response::DescribeConfigsResponse {
            ...
            results: (self.results).iter().map(DescribeConfigsResult::to_owned).collect(),
...
impl Encode for DescribeConfigsResponse<'_> {
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.results).len(), flex);
                let body: usize = (self.results).iter().map(|it| it.encoded_len(version)).sum();
                prefix + body
            };
        }
        if flex {
...
impl DescribeConfigsResult<'_> {
    ...
    pub fn to_owned(&self) -> crate::owned::describe_configs_response::DescribeConfigsResult {
        crate::owned::describe_configs_response::DescribeConfigsResult {
            ...
            configs: (self.configs).iter().map(DescribeConfigsResourceResult::to_owned).collect(),
            unknown_tagged_fields: self.unknown_tagged_fields.clone(),
        }
    }
}
...
impl<'de> DecodeBorrow<'de> for DescribeConfigsResult<'de> {
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.resource_name = if flex { get_compact_string_borrowed(buf)? } else { get_string_borrowed(buf)? };
        }
        if version >= 0 {
            out.configs = {
                let n = crate::primitives::array::get_array_len(buf, flex)?;
...
impl<'a> DescribeConfigsResourceResult<'a> {
    ...
    pub fn to_owned(&self) -> crate::owned::describe_configs_response::DescribeConfigsResourceResult {
        crate::owned::describe_configs_response::DescribeConfigsResourceResult {
            ...
            synonyms: (self.synonyms).iter().map(DescribeConfigsSynonym::to_owned).collect(),
    ...
    fn encode_field_1<B: BufMut>(&self, buf: &mut B, version: i16, flex: bool) {
        if version >= 0 {
            if flex { put_compact_nullable_string(buf, self.value) } else { put_nullable_string(buf, self.value) }
        }
    }
    ...
    fn encode_field_7<B: BufMut>(&self, buf: &mut B, version: i16, flex: bool) {
        if version >= 3 {
            if flex { put_compact_nullable_string(buf, self.documentation) } else { put_nullable_string(buf, self.documentation) }
        }
    }
    ...
    fn decode_field_0(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.name = if flex { get_compact_string_borrowed(buf)? } else { get_string_borrowed(buf)? };
        }
        Ok(())
    }
    fn decode_field_1(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 0 {
            out.value = if flex { get_compact_nullable_string_borrowed(buf)? } else { get_nullable_string_borrowed(buf)? };
        }
        Ok(())
    }
    ...
    fn decode_field_7(out: &mut Self, buf: &mut &'a [u8], version: i16, flex: bool) -> Result<(), ProtocolError> {
        if version >= 3 {
            out.documentation = if flex { get_compact_nullable_string_borrowed(buf)? } else { get_nullable_string_borrowed(buf)? };
        }
        Ok(())
    }
...
impl Encode for DescribeConfigsResourceResult<'_> {
    ...
    fn encoded_len(&self, version: i16) -> usize {
        ...
        if version >= 0 {
            n += if flex { compact_nullable_string_len(self.value) } else { nullable_string_len(self.value) };
        }
        if version >= 0 {
            n += 1;
        }
        ...
        if version >= 1 {
            n += {
                let prefix = crate::primitives::array::array_len_prefix_len((self.synonyms).len(), flex);
                let body: usize = (self.synonyms).iter().map(|it| it.encoded_len(version)).sum();
                prefix + body
            };
        }
        if version >= 3 {
        ...
        if version >= 3 {
            n += if flex { compact_nullable_string_len(self.documentation) } else { nullable_string_len(self.documentation) };
        }
        if flex {
            let known_pairs: Vec<(u32, usize)> = Vec::new();
            n += tagged_fields_len(&known_pairs, &self.unknown_tagged_fields);
