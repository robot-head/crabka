...
impl<'a> Default for ReadShareGroupStateSummaryRequest<'a> {
    fn default() -> Self {
        Self {
            group_id: "",
            topics: Vec::new(),
...
impl<'a> ReadShareGroupStateSummaryRequest<'a> {
    pub fn to_owned(&self) -> crate::owned::read_share_group_state_summary_request::ReadShareGroupStateSummaryRequest {
...
impl<'a> Encode for ReadShareGroupStateSummaryRequest<'a> {
...
impl<'de> DecodeBorrow<'de> for ReadShareGroupStateSummaryRequest<'de> {
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 { out.topics = { let n = crate::primitives::array::get_array_len(buf, flex)?; let mut v = Vec::with_capacity(n); for _ in 0..n { v.push(ReadStateSummaryData::decode_borrow(buf, version)?); } v }; }
        if flex {
...
impl ReadStateSummaryData {
    pub fn to_owned(&self) -> crate::owned::read_share_group_state_summary_request::ReadStateSummaryData {
