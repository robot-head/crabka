...
impl RemotePartitionDeleteMetadataRecord<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::remote_partition_delete_metadata_record::RemotePartitionDeleteMetadataRecord {
...
impl Encode for RemotePartitionDeleteMetadataRecord<'_> {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        if !(MIN_VERSION..=MAX_VERSION).contains(&version) {
            return Err(ProtocolError::SchemaMismatch("RemotePartitionDeleteMetadataRecord version out of range"));
        }
...
impl TopicIdPartitionEntry<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::remote_partition_delete_metadata_record::TopicIdPartitionEntry {
