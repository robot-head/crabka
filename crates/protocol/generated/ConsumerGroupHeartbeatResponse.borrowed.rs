...
impl ConsumerGroupHeartbeatResponse<'_> {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::consumer_group_heartbeat_response::ConsumerGroupHeartbeatResponse {
...
impl<'de> DecodeBorrow<'de> for ConsumerGroupHeartbeatResponse<'de> {
    fn decode_borrow(buf: &mut &'de [u8], version: i16) -> Result<Self, ProtocolError> {
        ...
        if version >= 0 {
            out.assignment = if get_i8(buf)? < 0 { None } else { Some(Assignment::decode_borrow(buf, version)?) };
        }
        if flex {
...
pub struct Assignment {
    pub topic_partitions: Vec<super::common::consumer_group_heartbeat_response::topic_partitions::TopicPartitions>,
    pub unknown_tagged_fields: UnknownTaggedFields,
}
impl Assignment {
    #[must_use]
    pub fn to_owned(&self) -> crate::owned::consumer_group_heartbeat_response::Assignment {
        crate::owned::consumer_group_heartbeat_response::Assignment {
            topic_partitions: (self.topic_partitions).iter().map(super::common::consumer_group_heartbeat_response::topic_partitions::TopicPartitions::to_owned).collect(),
            unknown_tagged_fields: self.unknown_tagged_fields.clone(),
        }
    }
}
