...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AddOffsetsToTxnResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AddOffsetsToTxnResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AddOffsetsToTxnResponse::default()),
            ("populated", AddOffsetsToTxnResponse::populated),
        ];
