...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ConsumerGroupHeartbeatResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ConsumerGroupHeartbeatResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ConsumerGroupHeartbeatResponse::default()),
            ("populated", ConsumerGroupHeartbeatResponse::populated),
        ];
