...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &EndQuorumEpochRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> EndQuorumEpochRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| EndQuorumEpochRequest::default()),
            ("populated", EndQuorumEpochRequest::populated),
        ];
