...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeAclsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeAclsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeAclsRequest::default()),
            ("populated", DescribeAclsRequest::populated),
        ];
