...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &VotersRecord, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> VotersRecord);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| VotersRecord::default()),
            ("populated", VotersRecord::populated),
        ];
