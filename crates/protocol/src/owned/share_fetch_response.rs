...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ShareFetchResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ShareFetchResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ShareFetchResponse::default()),
            ("populated", ShareFetchResponse::populated),
        ];
