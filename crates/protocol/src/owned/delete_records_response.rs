...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DeleteRecordsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DeleteRecordsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DeleteRecordsResponse::default()),
            ("populated", DeleteRecordsResponse::populated),
        ];
