...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AddRaftVoterResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AddRaftVoterResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AddRaftVoterResponse::default()),
            ("populated", AddRaftVoterResponse::populated),
        ];
