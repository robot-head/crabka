...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AlterClientQuotasResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AlterClientQuotasResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AlterClientQuotasResponse::default()),
            ("populated", AlterClientQuotasResponse::populated),
        ];
