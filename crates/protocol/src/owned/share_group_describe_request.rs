...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ShareGroupDescribeRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ShareGroupDescribeRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ShareGroupDescribeRequest::default()),
            ("populated", ShareGroupDescribeRequest::populated),
        ];
