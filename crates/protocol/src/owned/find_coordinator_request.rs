...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &FindCoordinatorRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> FindCoordinatorRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| FindCoordinatorRequest::default()),
            ("populated", FindCoordinatorRequest::populated),
        ];
