...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ElectLeadersResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ElectLeadersResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ElectLeadersResponse::default()),
            ("populated", ElectLeadersResponse::populated),
        ];
