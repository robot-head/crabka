...
mod tests {
    ...
    fn roundtrip(msg: &ConsumerProtocolSubscription, v: i16) {
    ...
    fn default_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&ConsumerProtocolSubscription::default(), v);
        }
    }
    #[test]
    fn populated_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&ConsumerProtocolSubscription::populated(v), v);
        }
    }
}
