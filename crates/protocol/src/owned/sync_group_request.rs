...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &SyncGroupRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> SyncGroupRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| SyncGroupRequest::default()),
            ("populated", SyncGroupRequest::populated),
        ];
