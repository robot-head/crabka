...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &InitProducerIdRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> InitProducerIdRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| InitProducerIdRequest::default()),
            ("populated", InitProducerIdRequest::populated),
        ];
