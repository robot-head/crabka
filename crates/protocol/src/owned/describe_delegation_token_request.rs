...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeDelegationTokenRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeDelegationTokenRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeDelegationTokenRequest::default()),
            ("populated", DescribeDelegationTokenRequest::populated),
        ];
