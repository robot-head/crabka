...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ListGroupsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ListGroupsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ListGroupsRequest::default()),
            ("populated", ListGroupsRequest::populated),
        ];
