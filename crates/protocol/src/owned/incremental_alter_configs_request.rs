...
mod tests {
    ...
    fn roundtrip(msg: &IncrementalAlterConfigsRequest, v: i16) {
    ...
    fn default_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&IncrementalAlterConfigsRequest::default(), v);
        }
    }
    #[test]
    fn populated_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&IncrementalAlterConfigsRequest::populated(v), v);
        }
    }
}
