...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AssignReplicasToDirsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AssignReplicasToDirsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AssignReplicasToDirsRequest::default()),
            ("populated", AssignReplicasToDirsRequest::populated),
        ];
