...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &HeartbeatResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> HeartbeatResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| HeartbeatResponse::default()),
            ("populated", HeartbeatResponse::populated),
        ];
