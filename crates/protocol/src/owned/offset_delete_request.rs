...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &OffsetDeleteRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> OffsetDeleteRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| OffsetDeleteRequest::default()),
            ("populated", OffsetDeleteRequest::populated),
        ];
