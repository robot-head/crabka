...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &EnvelopeRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> EnvelopeRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| EnvelopeRequest::default()),
            ("populated", EnvelopeRequest::populated),
        ];
