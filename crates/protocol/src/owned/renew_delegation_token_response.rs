...
mod tests {
    ...
    fn roundtrip(msg: &RenewDelegationTokenResponse, v: i16) {
    ...
    fn default_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&RenewDelegationTokenResponse::default(), v);
        }
    }
    #[test]
    fn populated_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&RenewDelegationTokenResponse::populated(v), v);
        }
    }
}
