...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &LeaderChangeMessage, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> LeaderChangeMessage);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| LeaderChangeMessage::default()),
            ("populated", LeaderChangeMessage::populated),
        ];
