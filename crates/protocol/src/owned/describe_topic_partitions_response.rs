...
mod tests {
    ...
    fn roundtrip(case: &str, msg: &DescribeTopicPartitionsResponse, v: i16) {
    ...
    fn roundtrip_cases_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            for (case, msg) in [
                ("default", DescribeTopicPartitionsResponse::default()),
                ("populated", DescribeTopicPartitionsResponse::populated(v)),
            ] {
