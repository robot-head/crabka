...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &RemoveDelegationTokenRecord, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> RemoveDelegationTokenRecord);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| RemoveDelegationTokenRecord::default()),
            ("populated", RemoveDelegationTokenRecord::populated),
        ];
