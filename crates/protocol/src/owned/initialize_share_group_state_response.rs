...
mod tests {
    ...
    fn roundtrip(msg: &InitializeShareGroupStateResponse, v: i16) {
    ...
    fn default_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&InitializeShareGroupStateResponse::default(), v);
        }
    }
    #[test]
    fn populated_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&InitializeShareGroupStateResponse::populated(v), v);
        }
    }
}
