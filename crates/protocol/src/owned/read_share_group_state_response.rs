...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ReadShareGroupStateResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ReadShareGroupStateResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ReadShareGroupStateResponse::default()),
            ("populated", ReadShareGroupStateResponse::populated),
        ];
