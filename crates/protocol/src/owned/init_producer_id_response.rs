...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &InitProducerIdResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> InitProducerIdResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| InitProducerIdResponse::default()),
            ("populated", InitProducerIdResponse::populated),
        ];
