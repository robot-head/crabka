...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ResponseHeader, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ResponseHeader);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ResponseHeader::default()),
            ("populated", ResponseHeader::populated),
        ];
