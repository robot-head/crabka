...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &RemoteLogSegmentMetadataSnapshotRecord, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> RemoteLogSegmentMetadataSnapshotRecord);
        let cases: [TestCase1<'_>; 2] = [
            ...
            (
                "populated",
                RemoteLogSegmentMetadataSnapshotRecord::populated,
            ),
        ];
