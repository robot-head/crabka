...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &InitializeShareGroupStateRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> InitializeShareGroupStateRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| InitializeShareGroupStateRequest::default()),
            ("populated", InitializeShareGroupStateRequest::populated),
        ];
