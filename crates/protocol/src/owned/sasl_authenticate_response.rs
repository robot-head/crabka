...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &SaslAuthenticateResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> SaslAuthenticateResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| SaslAuthenticateResponse::default()),
            ("populated", SaslAuthenticateResponse::populated),
        ];
