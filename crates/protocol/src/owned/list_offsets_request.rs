...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ListOffsetsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ListOffsetsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ListOffsetsRequest::default()),
            ("populated", ListOffsetsRequest::populated),
        ];
