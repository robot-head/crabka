...
mod tests {
    ...
    fn roundtrip(case: &str, msg: &ConsumerGroupDescribeRequest, v: i16) {
    ...
    fn roundtrip_cases_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            for (case, msg) in [
                ("default", ConsumerGroupDescribeRequest::default()),
                ("populated", ConsumerGroupDescribeRequest::populated(v)),
            ] {
