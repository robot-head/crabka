...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ConsumerGroupDescribeRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ConsumerGroupDescribeRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ConsumerGroupDescribeRequest::default()),
            ("populated", ConsumerGroupDescribeRequest::populated),
        ];
