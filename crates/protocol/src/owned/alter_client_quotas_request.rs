...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AlterClientQuotasRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AlterClientQuotasRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AlterClientQuotasRequest::default()),
            ("populated", AlterClientQuotasRequest::populated),
        ];
