...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AddPartitionsToTxnResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AddPartitionsToTxnResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AddPartitionsToTxnResponse::default()),
            ("populated", AddPartitionsToTxnResponse::populated),
        ];
