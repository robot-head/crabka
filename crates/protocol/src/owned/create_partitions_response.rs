...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &CreatePartitionsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> CreatePartitionsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| CreatePartitionsResponse::default()),
            ("populated", CreatePartitionsResponse::populated),
        ];
