...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeAclsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeAclsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeAclsResponse::default()),
            ("populated", DescribeAclsResponse::populated),
        ];
