...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DeleteGroupsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DeleteGroupsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DeleteGroupsRequest::default()),
            ("populated", DeleteGroupsRequest::populated),
        ];
