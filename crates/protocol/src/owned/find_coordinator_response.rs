...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &FindCoordinatorResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> FindCoordinatorResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| FindCoordinatorResponse::default()),
            ("populated", FindCoordinatorResponse::populated),
        ];
