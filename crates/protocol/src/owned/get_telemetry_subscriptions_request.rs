...
mod tests {
    ...
    fn roundtrip(msg: &GetTelemetrySubscriptionsRequest, v: i16) {
    ...
    fn default_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&GetTelemetrySubscriptionsRequest::default(), v);
        }
    }
    ...
    fn populated_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&GetTelemetrySubscriptionsRequest::populated(v), v);
        }
    }
}
