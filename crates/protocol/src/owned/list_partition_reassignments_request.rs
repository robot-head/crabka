...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ListPartitionReassignmentsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ListPartitionReassignmentsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ListPartitionReassignmentsRequest::default()),
            ("populated", ListPartitionReassignmentsRequest::populated),
        ];
