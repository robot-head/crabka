...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeTransactionsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeTransactionsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeTransactionsRequest::default()),
            ("populated", DescribeTransactionsRequest::populated),
        ];
