...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DeleteGroupsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DeleteGroupsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DeleteGroupsResponse::default()),
            ("populated", DeleteGroupsResponse::populated),
        ];
