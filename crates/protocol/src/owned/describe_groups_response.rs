...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeGroupsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeGroupsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeGroupsResponse::default()),
            ("populated", DescribeGroupsResponse::populated),
        ];
