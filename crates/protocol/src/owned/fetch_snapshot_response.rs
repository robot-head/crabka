...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &FetchSnapshotResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> FetchSnapshotResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| FetchSnapshotResponse::default()),
            ("populated", FetchSnapshotResponse::populated),
        ];
