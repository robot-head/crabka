...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &CreateDelegationTokenResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> CreateDelegationTokenResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| CreateDelegationTokenResponse::default()),
            ("populated", CreateDelegationTokenResponse::populated),
        ];
