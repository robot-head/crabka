...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AlterPartitionReassignmentsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AlterPartitionReassignmentsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AlterPartitionReassignmentsRequest::default()),
            ("populated", AlterPartitionReassignmentsRequest::populated),
        ];
