...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &RemoteLogSegmentMetadataUpdateRecord, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> RemoteLogSegmentMetadataUpdateRecord);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| {
                RemoteLogSegmentMetadataUpdateRecord::default()
            }),
            ("populated", RemoteLogSegmentMetadataUpdateRecord::populated),
        ];
