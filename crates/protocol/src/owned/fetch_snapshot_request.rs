...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &FetchSnapshotRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> FetchSnapshotRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| FetchSnapshotRequest::default()),
            ("populated", FetchSnapshotRequest::populated),
        ];
