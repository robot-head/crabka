...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &WriteShareGroupStateResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> WriteShareGroupStateResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| WriteShareGroupStateResponse::default()),
            ("populated", WriteShareGroupStateResponse::populated),
        ];
