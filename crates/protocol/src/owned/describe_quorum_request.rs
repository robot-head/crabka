...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeQuorumRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeQuorumRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeQuorumRequest::default()),
            ("populated", DescribeQuorumRequest::populated),
        ];
