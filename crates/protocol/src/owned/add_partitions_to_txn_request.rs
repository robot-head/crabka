...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AddPartitionsToTxnRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AddPartitionsToTxnRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AddPartitionsToTxnRequest::default()),
            ("populated", AddPartitionsToTxnRequest::populated),
        ];
