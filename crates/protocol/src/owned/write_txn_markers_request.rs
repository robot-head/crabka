...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &WriteTxnMarkersRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> WriteTxnMarkersRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| WriteTxnMarkersRequest::default()),
            ("populated", WriteTxnMarkersRequest::populated),
        ];
