...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &GetTelemetrySubscriptionsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> GetTelemetrySubscriptionsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| GetTelemetrySubscriptionsResponse::default()),
            ("populated", GetTelemetrySubscriptionsResponse::populated),
        ];
