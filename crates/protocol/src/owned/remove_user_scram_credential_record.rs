...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &RemoveUserScramCredentialRecord, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> RemoveUserScramCredentialRecord);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| RemoveUserScramCredentialRecord::default()),
            ("populated", RemoveUserScramCredentialRecord::populated),
        ];
