...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ConsumerGroupDescribeResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ConsumerGroupDescribeResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ConsumerGroupDescribeResponse::default()),
            ("populated", ConsumerGroupDescribeResponse::populated),
        ];
