...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &UnregisterBrokerRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> UnregisterBrokerRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| UnregisterBrokerRequest::default()),
            ("populated", UnregisterBrokerRequest::populated),
        ];
