...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AlterConfigsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AlterConfigsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AlterConfigsResponse::default()),
            ("populated", AlterConfigsResponse::populated),
        ];
