...
mod tests {
    ...
    fn roundtrip(msg: &ExpireDelegationTokenResponse, v: i16) {
    ...
    fn default_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&ExpireDelegationTokenResponse::default(), v);
        }
    }
    #[test]
    fn populated_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&ExpireDelegationTokenResponse::populated(v), v);
        }
    }
}
