...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &RemoveRaftVoterRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> RemoveRaftVoterRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| RemoveRaftVoterRequest::default()),
            ("populated", RemoveRaftVoterRequest::populated),
        ];
