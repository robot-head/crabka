...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &LeaveGroupResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> LeaveGroupResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| LeaveGroupResponse::default()),
            ("populated", LeaveGroupResponse::populated),
        ];
