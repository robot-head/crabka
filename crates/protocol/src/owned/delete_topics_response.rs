...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DeleteTopicsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DeleteTopicsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DeleteTopicsResponse::default()),
            ("populated", DeleteTopicsResponse::populated),
        ];
