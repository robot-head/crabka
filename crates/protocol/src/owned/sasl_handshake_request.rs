...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &SaslHandshakeRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> SaslHandshakeRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| SaslHandshakeRequest::default()),
            ("populated", SaslHandshakeRequest::populated),
        ];
