...
mod tests {
    ...
    fn roundtrip(case: &str, msg: &AlterShareGroupOffsetsRequest, v: i16) {
    ...
    fn roundtrip_cases_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            for (case, msg) in [
                ("default", AlterShareGroupOffsetsRequest::default()),
                ("populated", AlterShareGroupOffsetsRequest::populated(v)),
            ] {
