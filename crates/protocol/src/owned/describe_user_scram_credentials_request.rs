...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeUserScramCredentialsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeUserScramCredentialsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| {
                DescribeUserScramCredentialsRequest::default()
            }),
            ("populated", DescribeUserScramCredentialsRequest::populated),
        ];
