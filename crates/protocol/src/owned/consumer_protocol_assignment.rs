...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ConsumerProtocolAssignment, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ConsumerProtocolAssignment);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ConsumerProtocolAssignment::default()),
            ("populated", ConsumerProtocolAssignment::populated),
        ];
