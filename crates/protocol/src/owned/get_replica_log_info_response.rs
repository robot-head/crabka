...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &GetReplicaLogInfoResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> GetReplicaLogInfoResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| GetReplicaLogInfoResponse::default()),
            ("populated", GetReplicaLogInfoResponse::populated),
        ];
