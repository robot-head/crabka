...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &RegisterControllerRecord, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> RegisterControllerRecord);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| RegisterControllerRecord::default()),
            ("populated", RegisterControllerRecord::populated),
        ];
