...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ProduceRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ProduceRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ProduceRequest::default()),
            ("populated", ProduceRequest::populated),
        ];
