...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ProduceResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ProduceResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ProduceResponse::default()),
            ("populated", ProduceResponse::populated),
        ];
