...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &UpdateRaftVoterResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> UpdateRaftVoterResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| UpdateRaftVoterResponse::default()),
            ("populated", UpdateRaftVoterResponse::populated),
        ];
