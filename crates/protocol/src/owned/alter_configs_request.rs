...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AlterConfigsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AlterConfigsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AlterConfigsRequest::default()),
            ("populated", AlterConfigsRequest::populated),
        ];
