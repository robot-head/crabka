...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ElectLeadersRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ElectLeadersRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ElectLeadersRequest::default()),
            ("populated", ElectLeadersRequest::populated),
        ];
