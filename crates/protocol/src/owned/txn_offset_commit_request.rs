...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &TxnOffsetCommitRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> TxnOffsetCommitRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| TxnOffsetCommitRequest::default()),
            ("populated", TxnOffsetCommitRequest::populated),
        ];
