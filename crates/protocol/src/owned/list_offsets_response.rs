...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ListOffsetsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ListOffsetsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ListOffsetsResponse::default()),
            ("populated", ListOffsetsResponse::populated),
        ];
