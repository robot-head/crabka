...
mod tests {
    ...
    fn roundtrip(msg: &BrokerRegistrationChangeRecord, v: i16) {
    ...
    fn default_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&BrokerRegistrationChangeRecord::default(), v);
        }
    }
    #[test]
    fn populated_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&BrokerRegistrationChangeRecord::populated(v), v);
        }
    }
}
