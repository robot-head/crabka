...
mod tests {
    ...
    fn roundtrip(case: &str, msg: &AllocateProducerIdsResponse, v: i16) {
    ...
    fn roundtrip_cases_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            for (case, msg) in [
                ("default", AllocateProducerIdsResponse::default()),
                ("populated", AllocateProducerIdsResponse::populated(v)),
            ] {
