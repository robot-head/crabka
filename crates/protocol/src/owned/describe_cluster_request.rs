...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeClusterRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeClusterRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeClusterRequest::default()),
            ("populated", DescribeClusterRequest::populated),
        ];
