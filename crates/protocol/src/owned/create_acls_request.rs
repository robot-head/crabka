...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &CreateAclsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> CreateAclsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| CreateAclsRequest::default()),
            ("populated", CreateAclsRequest::populated),
        ];
