...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &MetadataRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> MetadataRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| MetadataRequest::default()),
            ("populated", MetadataRequest::populated),
        ];
