...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &EndTxnMarker, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> EndTxnMarker);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| EndTxnMarker::default()),
            ("populated", EndTxnMarker::populated),
        ];
