...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &CreateAclsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> CreateAclsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| CreateAclsResponse::default()),
            ("populated", CreateAclsResponse::populated),
        ];
