...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ShareAcknowledgeRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ShareAcknowledgeRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ShareAcknowledgeRequest::default()),
            ("populated", ShareAcknowledgeRequest::populated),
        ];
