...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeQuorumResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeQuorumResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeQuorumResponse::default()),
            ("populated", DescribeQuorumResponse::populated),
        ];
