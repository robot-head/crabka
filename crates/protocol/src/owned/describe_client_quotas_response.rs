...
mod tests {
    ...
    fn roundtrip(msg: &DescribeClientQuotasResponse, v: i16) {
    ...
    fn default_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&DescribeClientQuotasResponse::default(), v);
        }
    }
    ...
    fn populated_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&DescribeClientQuotasResponse::populated(v), v);
        }
    }
}
