...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ListTransactionsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ListTransactionsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ListTransactionsRequest::default()),
            ("populated", ListTransactionsRequest::populated),
        ];
