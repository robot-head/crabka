...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeLogDirsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeLogDirsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeLogDirsRequest::default()),
            ("populated", DescribeLogDirsRequest::populated),
        ];
