...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &BeginQuorumEpochResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> BeginQuorumEpochResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| BeginQuorumEpochResponse::default()),
            ("populated", BeginQuorumEpochResponse::populated),
        ];
