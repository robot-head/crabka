...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DeleteRecordsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DeleteRecordsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DeleteRecordsRequest::default()),
            ("populated", DeleteRecordsRequest::populated),
        ];
