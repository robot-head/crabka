...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DefaultPrincipalData, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DefaultPrincipalData);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DefaultPrincipalData::default()),
            ("populated", DefaultPrincipalData::populated),
        ];
