...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &OffsetCommitResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> OffsetCommitResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| OffsetCommitResponse::default()),
            ("populated", OffsetCommitResponse::populated),
        ];
