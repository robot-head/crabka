...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ApiVersionsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ApiVersionsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ApiVersionsRequest::default()),
            ("populated", ApiVersionsRequest::populated),
        ];
