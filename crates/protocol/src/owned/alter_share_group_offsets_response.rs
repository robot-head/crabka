...
mod tests {
    ...
    fn roundtrip(msg: &AlterShareGroupOffsetsResponse, v: i16) {
    ...
    fn default_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&AlterShareGroupOffsetsResponse::default(), v);
        }
    }
    #[test]
    fn populated_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&AlterShareGroupOffsetsResponse::populated(v), v);
        }
    }
}
