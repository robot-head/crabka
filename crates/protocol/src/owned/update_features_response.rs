...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &UpdateFeaturesResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> UpdateFeaturesResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| UpdateFeaturesResponse::default()),
            ("populated", UpdateFeaturesResponse::populated),
        ];
