...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &CreatePartitionsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> CreatePartitionsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| CreatePartitionsRequest::default()),
            ("populated", CreatePartitionsRequest::populated),
        ];
