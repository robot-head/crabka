...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeProducersRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeProducersRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeProducersRequest::default()),
            ("populated", DescribeProducersRequest::populated),
        ];
