...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &EndQuorumEpochResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> EndQuorumEpochResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| EndQuorumEpochResponse::default()),
            ("populated", EndQuorumEpochResponse::populated),
        ];
