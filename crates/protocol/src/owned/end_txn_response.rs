...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &EndTxnResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> EndTxnResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| EndTxnResponse::default()),
            ("populated", EndTxnResponse::populated),
        ];
