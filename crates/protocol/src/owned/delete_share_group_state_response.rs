...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DeleteShareGroupStateResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DeleteShareGroupStateResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DeleteShareGroupStateResponse::default()),
            ("populated", DeleteShareGroupStateResponse::populated),
        ];
