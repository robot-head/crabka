...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &SnapshotFooterRecord, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> SnapshotFooterRecord);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| SnapshotFooterRecord::default()),
            ("populated", SnapshotFooterRecord::populated),
        ];
