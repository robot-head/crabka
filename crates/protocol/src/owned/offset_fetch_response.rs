...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &OffsetFetchResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> OffsetFetchResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| OffsetFetchResponse::default()),
            ("populated", OffsetFetchResponse::populated),
        ];
