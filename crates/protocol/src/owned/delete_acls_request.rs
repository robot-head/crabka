...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DeleteAclsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DeleteAclsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DeleteAclsRequest::default()),
            ("populated", DeleteAclsRequest::populated),
        ];
