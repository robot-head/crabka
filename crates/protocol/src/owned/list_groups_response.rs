...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ListGroupsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ListGroupsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ListGroupsResponse::default()),
            ("populated", ListGroupsResponse::populated),
        ];
