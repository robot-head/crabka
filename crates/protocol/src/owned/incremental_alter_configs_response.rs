...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &IncrementalAlterConfigsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> IncrementalAlterConfigsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| IncrementalAlterConfigsResponse::default()),
            ("populated", IncrementalAlterConfigsResponse::populated),
        ];
