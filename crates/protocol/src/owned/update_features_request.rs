...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &UpdateFeaturesRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> UpdateFeaturesRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| UpdateFeaturesRequest::default()),
            ("populated", UpdateFeaturesRequest::populated),
        ];
