...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DeleteAclsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DeleteAclsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DeleteAclsResponse::default()),
            ("populated", DeleteAclsResponse::populated),
        ];
