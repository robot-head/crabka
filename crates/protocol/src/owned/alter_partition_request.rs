...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AlterPartitionRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AlterPartitionRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AlterPartitionRequest::default()),
            ("populated", AlterPartitionRequest::populated),
        ];
