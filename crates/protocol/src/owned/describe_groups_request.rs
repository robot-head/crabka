...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeGroupsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeGroupsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeGroupsRequest::default()),
            ("populated", DescribeGroupsRequest::populated),
        ];
