...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &RemoveAccessControlEntryRecord, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> RemoveAccessControlEntryRecord);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| RemoveAccessControlEntryRecord::default()),
            ("populated", RemoveAccessControlEntryRecord::populated),
        ];
