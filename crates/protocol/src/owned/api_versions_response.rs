...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ApiVersionsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ApiVersionsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ApiVersionsResponse::default()),
            ("populated", ApiVersionsResponse::populated),
        ];
