...
mod tests {
    ...
    fn roundtrip(msg: &StreamsGroupHeartbeatResponse, v: i16) {
    ...
    fn default_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&StreamsGroupHeartbeatResponse::default(), v);
        }
    }
    ...
    fn populated_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&StreamsGroupHeartbeatResponse::populated(v), v);
        }
    }
}
