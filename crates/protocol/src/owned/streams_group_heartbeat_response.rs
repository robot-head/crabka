...
mod tests {
    ...
    fn roundtrip(case: &str, msg: &StreamsGroupHeartbeatResponse, v: i16) {
    ...
    fn roundtrip_cases_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            for (case, msg) in [
                ("default", StreamsGroupHeartbeatResponse::default()),
                ("populated", StreamsGroupHeartbeatResponse::populated(v)),
            ] {
