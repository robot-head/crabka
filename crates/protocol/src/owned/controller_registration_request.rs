...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ControllerRegistrationRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ControllerRegistrationRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ControllerRegistrationRequest::default()),
            ("populated", ControllerRegistrationRequest::populated),
        ];
