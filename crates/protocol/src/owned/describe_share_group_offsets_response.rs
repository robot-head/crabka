...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeShareGroupOffsetsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeShareGroupOffsetsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeShareGroupOffsetsResponse::default()),
            ("populated", DescribeShareGroupOffsetsResponse::populated),
        ];
