...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeProducersResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeProducersResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeProducersResponse::default()),
            ("populated", DescribeProducersResponse::populated),
        ];
