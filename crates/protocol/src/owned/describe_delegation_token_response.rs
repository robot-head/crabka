...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeDelegationTokenResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeDelegationTokenResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeDelegationTokenResponse::default()),
            ("populated", DescribeDelegationTokenResponse::populated),
        ];
