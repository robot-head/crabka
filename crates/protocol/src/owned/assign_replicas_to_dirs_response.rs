...
mod tests {
    ...
    fn roundtrip(msg: &AssignReplicasToDirsResponse, v: i16) {
    ...
    fn default_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&AssignReplicasToDirsResponse::default(), v);
        }
    }
    ...
    fn populated_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&AssignReplicasToDirsResponse::populated(v), v);
        }
    }
}
