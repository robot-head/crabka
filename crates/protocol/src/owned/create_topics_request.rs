...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &CreateTopicsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> CreateTopicsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| CreateTopicsRequest::default()),
            ("populated", CreateTopicsRequest::populated),
        ];
