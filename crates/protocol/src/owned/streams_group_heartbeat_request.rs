...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &StreamsGroupHeartbeatRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> StreamsGroupHeartbeatRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| StreamsGroupHeartbeatRequest::default()),
            ("populated", StreamsGroupHeartbeatRequest::populated),
        ];
