...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &JoinGroupRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> JoinGroupRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| JoinGroupRequest::default()),
            ("populated", JoinGroupRequest::populated),
        ];
