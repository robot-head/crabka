...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ReadShareGroupStateSummaryRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ReadShareGroupStateSummaryRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ReadShareGroupStateSummaryRequest::default()),
            ("populated", ReadShareGroupStateSummaryRequest::populated),
        ];
