...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &FetchRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> FetchRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| FetchRequest::default()),
            ("populated", FetchRequest::populated),
        ];
