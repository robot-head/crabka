...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeShareGroupOffsetsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeShareGroupOffsetsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeShareGroupOffsetsRequest::default()),
            ("populated", DescribeShareGroupOffsetsRequest::populated),
        ];
