...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AlterUserScramCredentialsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AlterUserScramCredentialsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AlterUserScramCredentialsRequest::default()),
            ("populated", AlterUserScramCredentialsRequest::populated),
        ];
