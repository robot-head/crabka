...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &WriteTxnMarkersResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> WriteTxnMarkersResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| WriteTxnMarkersResponse::default()),
            ("populated", WriteTxnMarkersResponse::populated),
        ];
