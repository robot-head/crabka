...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &HeartbeatRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> HeartbeatRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| HeartbeatRequest::default()),
            ("populated", HeartbeatRequest::populated),
        ];
