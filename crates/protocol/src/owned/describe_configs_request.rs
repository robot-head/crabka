...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeConfigsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeConfigsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeConfigsRequest::default()),
            ("populated", DescribeConfigsRequest::populated),
        ];
