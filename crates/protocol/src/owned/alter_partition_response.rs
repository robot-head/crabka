...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AlterPartitionResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AlterPartitionResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AlterPartitionResponse::default()),
            ("populated", AlterPartitionResponse::populated),
        ];
