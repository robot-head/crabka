...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DeleteShareGroupOffsetsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DeleteShareGroupOffsetsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DeleteShareGroupOffsetsResponse::default()),
            ("populated", DeleteShareGroupOffsetsResponse::populated),
        ];
