...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ListPartitionReassignmentsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ListPartitionReassignmentsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ListPartitionReassignmentsResponse::default()),
            ("populated", ListPartitionReassignmentsResponse::populated),
        ];
