...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &UserScramCredentialRecord, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> UserScramCredentialRecord);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| UserScramCredentialRecord::default()),
            ("populated", UserScramCredentialRecord::populated),
        ];
