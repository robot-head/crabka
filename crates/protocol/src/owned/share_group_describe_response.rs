...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ShareGroupDescribeResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ShareGroupDescribeResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ShareGroupDescribeResponse::default()),
            ("populated", ShareGroupDescribeResponse::populated),
        ];
