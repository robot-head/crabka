...
mod tests {
    ...
    fn roundtrip(case: &str, msg: &ReadShareGroupStateSummaryResponse, v: i16) {
    ...
    fn roundtrip_cases_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            for (case, msg) in [
                ("default", ReadShareGroupStateSummaryResponse::default()),
                (
                    "populated",
                    ReadShareGroupStateSummaryResponse::populated(v),
                ),
            ] {
