...
mod tests {
    ...
    fn roundtrip(msg: &ReadShareGroupStateSummaryResponse, v: i16) {
    ...
    fn default_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&ReadShareGroupStateSummaryResponse::default(), v);
        }
    }
    ...
    fn populated_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&ReadShareGroupStateSummaryResponse::populated(v), v);
        }
    }
}
