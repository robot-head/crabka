...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DeleteTopicsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DeleteTopicsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DeleteTopicsRequest::default()),
            ("populated", DeleteTopicsRequest::populated),
        ];
