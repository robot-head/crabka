...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DescribeConfigsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DescribeConfigsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DescribeConfigsResponse::default()),
            ("populated", DescribeConfigsResponse::populated),
        ];
