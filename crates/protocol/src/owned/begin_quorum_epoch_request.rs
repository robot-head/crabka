...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &BeginQuorumEpochRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> BeginQuorumEpochRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| BeginQuorumEpochRequest::default()),
            ("populated", BeginQuorumEpochRequest::populated),
        ];
