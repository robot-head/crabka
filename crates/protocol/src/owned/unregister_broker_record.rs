...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &UnregisterBrokerRecord, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> UnregisterBrokerRecord);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| UnregisterBrokerRecord::default()),
            ("populated", UnregisterBrokerRecord::populated),
        ];
