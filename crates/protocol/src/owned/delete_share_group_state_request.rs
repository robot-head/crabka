...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &DeleteShareGroupStateRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> DeleteShareGroupStateRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| DeleteShareGroupStateRequest::default()),
            ("populated", DeleteShareGroupStateRequest::populated),
        ];
