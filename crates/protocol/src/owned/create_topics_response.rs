...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &CreateTopicsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> CreateTopicsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| CreateTopicsResponse::default()),
            ("populated", CreateTopicsResponse::populated),
        ];
