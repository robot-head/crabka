...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ShareGroupHeartbeatResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ShareGroupHeartbeatResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ShareGroupHeartbeatResponse::default()),
            ("populated", ShareGroupHeartbeatResponse::populated),
        ];
