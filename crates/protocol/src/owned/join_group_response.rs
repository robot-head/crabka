...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &JoinGroupResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> JoinGroupResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| JoinGroupResponse::default()),
            ("populated", JoinGroupResponse::populated),
        ];
