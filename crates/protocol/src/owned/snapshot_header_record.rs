...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &SnapshotHeaderRecord, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> SnapshotHeaderRecord);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| SnapshotHeaderRecord::default()),
            ("populated", SnapshotHeaderRecord::populated),
        ];
