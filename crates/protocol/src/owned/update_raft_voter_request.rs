...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &UpdateRaftVoterRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> UpdateRaftVoterRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| UpdateRaftVoterRequest::default()),
            ("populated", UpdateRaftVoterRequest::populated),
        ];
