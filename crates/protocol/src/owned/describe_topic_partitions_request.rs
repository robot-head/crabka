...
mod tests {
    ...
    fn roundtrip(msg: &DescribeTopicPartitionsRequest, v: i16) {
    ...
    fn default_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&DescribeTopicPartitionsRequest::default(), v);
        }
    }
    ...
    fn populated_roundtrips_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            roundtrip(&DescribeTopicPartitionsRequest::populated(v), v);
        }
    }
}
