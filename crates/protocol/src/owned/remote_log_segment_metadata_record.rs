...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &RemoteLogSegmentMetadataRecord, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> RemoteLogSegmentMetadataRecord);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| RemoteLogSegmentMetadataRecord::default()),
            ("populated", RemoteLogSegmentMetadataRecord::populated),
        ];
