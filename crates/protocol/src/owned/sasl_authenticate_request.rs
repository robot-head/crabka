...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &SaslAuthenticateRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> SaslAuthenticateRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| SaslAuthenticateRequest::default()),
            ("populated", SaslAuthenticateRequest::populated),
        ];
