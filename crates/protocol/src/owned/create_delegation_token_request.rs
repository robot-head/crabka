...
mod tests {
    ...
    fn roundtrip(case: &str, msg: &CreateDelegationTokenRequest, v: i16) {
    ...
    fn roundtrip_cases_all_versions() {
        for v in MIN_VERSION..=MAX_VERSION {
            for (case, msg) in [
                ("default", CreateDelegationTokenRequest::default()),
                ("populated", CreateDelegationTokenRequest::populated(v)),
            ] {
