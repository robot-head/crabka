...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &CreateDelegationTokenRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> CreateDelegationTokenRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| CreateDelegationTokenRequest::default()),
            ("populated", CreateDelegationTokenRequest::populated),
        ];
