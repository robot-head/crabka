...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &ListConfigResourcesRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> ListConfigResourcesRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| ListConfigResourcesRequest::default()),
            ("populated", ListConfigResourcesRequest::populated),
        ];
