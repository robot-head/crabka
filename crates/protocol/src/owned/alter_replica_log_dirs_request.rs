...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AlterReplicaLogDirsRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AlterReplicaLogDirsRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AlterReplicaLogDirsRequest::default()),
            ("populated", AlterReplicaLogDirsRequest::populated),
        ];
