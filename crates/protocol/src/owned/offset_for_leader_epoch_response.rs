...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &OffsetForLeaderEpochResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> OffsetForLeaderEpochResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| OffsetForLeaderEpochResponse::default()),
            ("populated", OffsetForLeaderEpochResponse::populated),
        ];
