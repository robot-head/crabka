...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &VoteResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> VoteResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| VoteResponse::default()),
            ("populated", VoteResponse::populated),
        ];
