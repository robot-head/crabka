...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AddRaftVoterRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AddRaftVoterRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| AddRaftVoterRequest::default()),
            ("populated", AddRaftVoterRequest::populated),
        ];
