...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &BrokerRegistrationRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> BrokerRegistrationRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| BrokerRegistrationRequest::default()),
            ("populated", BrokerRegistrationRequest::populated),
        ];
