...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &PushTelemetryResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> PushTelemetryResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| PushTelemetryResponse::default()),
            ("populated", PushTelemetryResponse::populated),
        ];
