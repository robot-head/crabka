...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &PushTelemetryRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> PushTelemetryRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| PushTelemetryRequest::default()),
            ("populated", PushTelemetryRequest::populated),
        ];
