...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &BrokerHeartbeatRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> BrokerHeartbeatRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| BrokerHeartbeatRequest::default()),
            ("populated", BrokerHeartbeatRequest::populated),
        ];
