...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &AlterPartitionReassignmentsResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> AlterPartitionReassignmentsResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| {
                AlterPartitionReassignmentsResponse::default()
            }),
            ("populated", AlterPartitionReassignmentsResponse::populated),
        ];
