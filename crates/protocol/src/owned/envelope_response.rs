...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &EnvelopeResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> EnvelopeResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| EnvelopeResponse::default()),
            ("populated", EnvelopeResponse::populated),
        ];
