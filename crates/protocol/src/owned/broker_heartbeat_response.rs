...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &BrokerHeartbeatResponse, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> BrokerHeartbeatResponse);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| BrokerHeartbeatResponse::default()),
            ("populated", BrokerHeartbeatResponse::populated),
        ];
