...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &LeaveGroupRequest, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> LeaveGroupRequest);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| LeaveGroupRequest::default()),
            ("populated", LeaveGroupRequest::populated),
        ];
