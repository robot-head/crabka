...
mod tests {
    ...
    fn roundtrip(case_name: &str, msg: &RequestHeader, v: i16) {
    ...
    fn roundtrips_all_versions() {
        type TestCase1<'a> = (&'a str, fn(i16) -> RequestHeader);
        let cases: [TestCase1<'_>; 2] = [
            ("default", |_| RequestHeader::default()),
            ("populated", RequestHeader::populated),
        ];
