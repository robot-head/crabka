            ...
            n
                += if version <= 0 {
                    match &self.records {
                        ...
                        Some(__rb) => {
                            let __rb_len = <crate::records::RecordsPayloadBorrowed as crate::Encode>::encoded_len(
                                __rb,
                                version,
                            );
                            if flex {
                                crate::primitives::string_bytes::compact_bytes_len_from_size(
                                    __rb_len,
                                )
                            } else {
                                4 + __rb_len
