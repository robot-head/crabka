// AUTO-GENERATED by crabka-protocol-codegen against test. Do not edit.
...
impl<'a> Default for FetchRequest<'a> {
    fn default() -> Self {
        Self {
            replica_id: -1i32,
            max_wait_ms: 0i32,
...
impl<'a> Encode for FetchRequest<'a> {
...
impl<'a> Default for FetchTopic<'a> {
    fn default() -> Self {
        Self {
            topic: "",
...
impl<'a> Encode for FetchTopic<'a> {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        let flex = version >= 12;
...
impl<'a> Encode for ForgottenTopic<'a> {
    fn encode<B: BufMut>(&self, buf: &mut B, version: i16) -> Result<(), ProtocolError> {
        let flex = version >= 12;
