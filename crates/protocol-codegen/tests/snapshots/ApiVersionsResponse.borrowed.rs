...
impl ApiVersionsResponse {
    ...
    pub fn populated(version: i16) -> Self {
        ...
        if version >= 3 {
            m.supported_features = vec![
                crate
                ::owned::api_versions_response::SupportedFeatureKey::populated(version)
            ];
        }
        if version >= 3 {
        ...
        if version >= 3 {
            m.finalized_features = vec![
                crate
                ::owned::api_versions_response::FinalizedFeatureKey::populated(version)
            ];
        }
        if version >= 3 {
