...
pub struct Vector {
    ...
    /// Whether this vector requires the harness's real broker and gateway substrate.
    #[serde(default)]
    pub live_only: bool,
...
/// # Errors
///
/// Returns an error when the directory or a vector file cannot be read, or a
/// vector file contains invalid JSON.
...
/// # Errors
///
/// Returns an error when `text` is not a valid vector JSON document.
