#!/usr/bin/env bash
#
# Capture the 12 DSL golden fixtures from JVM Kafka Streams 4.1.0, inside Docker.
...
#  stream_stream_outer_join, session_count)
#
# Mechanism A (default, no broker): builds the 12 DSL topologies with optimization=all
