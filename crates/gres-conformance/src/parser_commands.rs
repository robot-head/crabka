...
const COMMAND_PROBES: &[CommandProbe] = &[
    ...
    CommandProbe {
        ...
        sql: "CREATE STATISTICS parser_commands_stats ON id, value FROM parser_commands_probe",
        expected_statement: "CreateStatistics",
        refusal: None,
    },
    CommandProbe {
        command: "ALTER STATISTICS",
        sql: "ALTER STATISTICS parser_commands_stats SET STATISTICS 100",
        expected_statement: "AlterStatistics",
        refusal: None,
    },
    CommandProbe {
        command: "DROP STATISTICS",
        sql: "DROP STATISTICS parser_commands_stats",
        expected_statement: "DropStatistics",
        refusal: None,
    },
    CommandProbe {
...
fn statement_shape(statement: &Statement) -> &'static str {
    match statement {
        ...
        Statement::CreateStatistics(_) => "CreateStatistics",
        Statement::AlterStatistics { .. } => "AlterStatistics",
        Statement::DropStatistics { .. } => "DropStatistics",
        ...
        Statement::GrantForeignPrivileges { .. } => "GrantForeignPrivileges",
        ...
        Statement::RevokeForeignPrivileges { .. } => "RevokeForeignPrivileges",
